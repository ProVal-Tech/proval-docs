---
id: 'cwa-m365-tenant-id'
title: 'M365 Tenant ID Management'
title_meta: 'M365 Tenant ID Management for OneDrive Group Policies'
keywords: ['m365', 'tenant', 'id', 'onedrive', 'group', 'policies']
description: 'This document explains the managed variable used to store the partner's Microsoft M365 tenant ID, which is essential for configuring various OneDrive group policies. It provides guidance on how partners can obtain their tenant ID and outlines the associated managed variable details.'
tags: ['configuration', 'software', 'windows', 'security']
draft: false
unlisted: false
---
## Summary
