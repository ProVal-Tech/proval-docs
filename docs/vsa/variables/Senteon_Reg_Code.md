...
tags: ['configuration', 'software', 'installation', 'setup']
draft: false
unlisted: false
---
## Summary

This managed variable is used to store the Senteon registration code of the Tenant the partner wishes to register the agent/endpoint to.
