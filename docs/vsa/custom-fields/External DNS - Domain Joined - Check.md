...
tags: ['dns', 'domain', 'check', 'machine', 'log', 'configuration', 'windows', 'security']
draft: false
unlisted: false
---
## Summary

This procedure checks to see if a machine is domain-joined or not and then checks the DNS settings on the machine.
...
| 1:40:14 pm 30-Aug-23   | Run Now - External DNS - Domain Joined - Check           | Admin derek.joniak scheduled procedure Run Now - External DNS - Domain Joined - Check to run at Aug 30 2023 2:40PM | derek.joniak  |

## Dependencies

[https://proval.itglue.com/DOC-5078775-13761628](https://proval.itglue.com/DOC-5078775-13761628)
