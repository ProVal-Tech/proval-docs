...
Creates a scheduled task on the endpoint.
...
Parameterizes Actions, Arguments, triggers to create a scheduled task. If AtLogon is chosen as the task trigger, it will run the task as the Users Group.
