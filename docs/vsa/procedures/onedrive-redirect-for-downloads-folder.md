...
This agent procedure runs PowerShell to redirect the system's "Downloads" folder to the OneDrive's download folder. This always pulls and sync the data from the "Downloads" folder to the OneDrive. 
