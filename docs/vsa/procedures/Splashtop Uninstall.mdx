...
| 12:36:37 pm 21-Jun-22   | Run Now - Splashtop Uninstall    | Admin provaltech.com/dan.hicks scheduled procedure Run Now - Splashtop Uninstall to run at Jun 21 2022 12:36PM |                               |

## Process

Uses WMI to detect if Splashtop is installed and removes. Checks again afterwards to ensure removal.
