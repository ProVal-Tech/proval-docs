...
tags: ['software', 'installation', 'uninstallation', 'update', 'configuration', 'windows']
draft: false
unlisted: false
---
## Summary

A Suite of 5 agent procedures to manage WinGet Packages on an endpoint using ProVal Agnostic Script [SWM - Software Management - Powershell - Invoke-WingetProessor](https://proval.itglue.com/DOC-5078775-11310973):
...
![Image 1](5078775/docs/11797575/images/22569461)

#packageID# - ensure this matches capitalization.

![Image 2](5078775/docs/11797575/images/22569645)

If you are unsure use winget search to find the proper name.

![Image 3](5078775/docs/11797575/images/22569715)

#AllowUpdate# - Leave this as 1, unless there's a need to not have updates.

![Image 4](5078775/docs/11797575/images/22569722)

#specifysource# - Leave this as 0, unless there's a need to for a particular package.

![Image 5](5078775/docs/11797575/images/22569727)

#optionalparameter# - This is set to 0 as default, but a common option that may be needed, are machine wide installation packages.

![Image 6](5078775/docs/11797575/images/22569733)

If we want to install a package machine wide we use this optionalparameter to specify so.

![Image 7](5078775/docs/11797575/images/22569747)

The parameter must be passed as an array, so ensure it matches as seen in the screenshot or copy it as seen below:
...
12:23:01 pm 6-Jan-23   Run Now - WinGet Package Install   Admin provaltech.com/dan.hicks scheduled procedure Run Now - WinGet Package Install to run at Jan 6 2023 12:23PM
...
Utilizes Agnostic Content [SWM - Software Management - Powershell - Invoke-WingetProessor](https://proval.itglue.com/DOC-5078775-11310973) to run WinGet as system user on an endpoint and manage application packages.
