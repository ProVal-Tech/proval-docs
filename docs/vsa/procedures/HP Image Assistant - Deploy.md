...
tags: ['installation', 'software', 'windows', 'update', 'networking']
draft: false
unlisted: false
---
## Summary
...
| 6:11:04 pm 4-Oct-23     | HP Image Assistant - Deploy                                                                                                                      | Deploying HP Image Assist   | pronoc |
...
| 6:10:52 pm 4-Oct-23     | Run Now - HP Image Assistant - Deploy                                                                                                            | Admin pronoc scheduled procedure Run Now - HP Image Assistant - Deploy to run at Oct 4 2023 7:10PM | pronoc |
...
Procedure is set to a default of:  /Operation:Analyze /Category:All /selection:All /action:download /silent /AutoCleanup /reportFolder:c:\HPIA\Report /softpaqdownloadfolder:"C:\Windows\temp"  
