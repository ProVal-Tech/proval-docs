...
tags: ['windows', 'mac', 'configuration', 'update', 'software', 'performance']
draft: false
unlisted: false
---
## Summary

Checks compatibility requirements for ProVal content on Mac and PC. OS Requirements are set based on contract standards of OS(n-2)
...
11:52:12 am 17-Nov-22   Run Now - ProVal Script Compatibility Update   Admin provaltech.com/dan.hicks scheduled procedure Run Now - ProVal Script Compatibility Update to run at Nov 17 2022 11:52AM   provalt
...
- **Windows**
  ...
  - Gets the OS Build version from registry
  - If Build > 7601
    - If Name != Windows 7
