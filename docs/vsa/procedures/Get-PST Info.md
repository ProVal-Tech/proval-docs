...
tags: ['backup', 'configuration', 'report', 'windows']
draft: false
unlisted: false
---
## Summary

This procedure gathers the name, location, and size of all the PST files on a machine and stores them in a log. If only one is present, it stores the location in the CF; if multiple are present, it updates the CF to advise to check the log.
...
| 8:26:49 am 17-Aug-23     | Run Now - Get-PST Info                                            | Admin derek.joniak scheduled procedure Run Now - Get-PST Info to run at Aug 17 2023 9:26AM | derek.joniak  |

## Dependencies

[https://proval.itglue.com/DOC-5078775-13650441](https://proval.itglue.com/DOC-5078775-13650441)
