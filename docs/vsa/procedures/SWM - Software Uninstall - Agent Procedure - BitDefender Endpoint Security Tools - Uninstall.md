...
tags: ['uninstallation', 'security', 'software', 'windows']
draft: false
unlisted: false
---
## Summary

Completely removes BitDefender Endpoint Security Tools from an endpoint.  
Implementation of agnostic content [SWM - Software Uninstall - Agnostic - Remove-BitdefenderEndpointSecurity](https://proval.itglue.com/DOC-5078775-11524980) 
...
1. Export the procedure from the ProVal VSA.  
   ...
   ![Image](5078775/docs/11613281/images/23051132)
   
2. Import the procedure from step 1 into the client's VSA  
   ![Image](5078775/docs/11613281/images/23051241)
...
4. There are two optional variables within the procedure.  
   ...
   ![Image](5078775/docs/11613281/images/23057651)  
   ...
   ![Image](5078775/docs/11613281/images/23057723)

## Process

1. The agent procedure creates a folder for the script and any necessary files.  
2. The agent procedure downloads the script from the ProVal file repo, and executes it.  
