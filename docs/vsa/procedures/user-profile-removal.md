...
| 8:41:43 am 1-Mar-23   | User Profile Removal-0004                    | ERROR: 2023-03-01 08:41:41 An error occurred when attempting to remove the user profile. Error: The process cannot access the file because it is being used by another process.                                                                  | dan.hicks |
