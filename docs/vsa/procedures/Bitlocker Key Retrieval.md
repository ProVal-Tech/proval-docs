...
tags: ['backup', 'security', 'configuration', 'windows']
draft: false
unlisted: false
---
## Summary

Retrieves any available bitlocker recovery key and saves it to xPVAL Bitlocker Key CF.
...
| 4:07:07 pm 13-Dec-22     | Run Now - Bitlocker Key Retrieval            | Admin provaltech.com/dan.hicks scheduled procedure Run Now - Bitlocker Key Retrieval to run at Dec 13 2022 4:07PM | provaltech.com/dan.hicks      |
...
Gets bitlocker recovery keys on endpoint and prints any that exist to the CF.
