...
title: 'Ticket Creation - Client'
title_meta: 'Ticket Creation - Client'
...
This script replicates the [Ticket Creation - Computer](/docs/63beba3c-f4a6-41a5-98e2-d4e4ce885035) script, with the key distinction being that it generates client-level tickets instead of computer-level tickets.
