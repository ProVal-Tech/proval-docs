...
description: 'This document details a modified script for the Webroot Plugin installation, enabling automatic deployment through ConnectWise Automate. It outlines the script's functionality, dependencies, variables, and process for both installed and non-installed software scenarios.'
tags: ['installation', 'software', 'connectwise', 'security', 'registry']
draft: false
unlisted: false
---
## Summary
...
![Sample Run](5078775/docs/11623253/images/16307648)
