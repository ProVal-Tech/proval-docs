...
![Sample Run](../../../static/img/docs/0bc76dfc-6e84-459d-83a8-306fe625c835/image_1.png)

## Dependencies

- **Client EDF**  
  ![Client EDF](../../../static/img/docs/0bc76dfc-6e84-459d-83a8-306fe625c835/image_2.png)

- **Agent EDF for exclusion** (Will prevent the monitor from picking up the agent / forcing DUO install)  
  ![Agent EDF](../../../static/img/docs/0bc76dfc-6e84-459d-83a8-306fe625c835/image_3.png)
