...
tags: ['configuration', 'script', 'monitor', 'update', 'windows']
draft: false
unlisted: false
---
## Summary
...
|----------------------------|----------------------------------------------------------|-----------|---------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| Winget Auto Update          | Enabled for Servers and Workstations                     | Dropdown  | - Disabled<br>- Enabled for Workstations Only<br>- Enabled for Servers and Workstations                                    | Set this EDF to enable the Winget Auto Update solution.                                              |
