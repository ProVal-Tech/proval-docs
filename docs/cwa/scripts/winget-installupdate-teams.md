...
title: 'Winget - Install/Update - Teams'
title_meta: 'Winget - Install/Update - Teams'
...
This document outlines the implementation of the [Winget - Install/Update](/docs/dd445ce7-a149-452c-9b35-dc1adbab4e06) script to deploy the `Teams Machine-Wide Installer` application.
