...
2. Add either the public or private IP address of the ESXi Host in the URL section of the entry. Do not use HTTP or HTTPS along with the IP address.  
   ...
   `10.0.0.4` ==> Correct
3. Sample Screenshot:  
   ![Sample Screenshot](../../../static/img/docs/830beb63-113a-406e-aef2-046403de9cb9/image_1.webp)
4. Add proper parameters while executing the script.  
   ![Parameters Screenshot](../../../static/img/docs/830beb63-113a-406e-aef2-046403de9cb9/image_2.webp)  
...
5. For alerting on failure:  
   ![Alerting Screenshot](../../../static/img/docs/830beb63-113a-406e-aef2-046403de9cb9/image_3.webp)  
