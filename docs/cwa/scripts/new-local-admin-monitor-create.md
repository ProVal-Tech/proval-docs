...
| NLA_Monitoring_Interval          | 3600              | True     | Controls the generated Remote Monitor run time interval. The default is 3600 seconds. <be> ![system_properties](../../../static/img/New-Local-Admin-Monitor---Create/image20.png)                                                                                                                                    |
