...
| NLA_Monitoring_TicketCategory     | 124               | False    | This system property stores the ID of the `Ticket Category` to apply to the remote monitors created for the all machines or for workstations only. The default value is '0', i.e., `<Not Specified>`.![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/image25.webp)  <br/><br/> Ticket Categories are used to control the CW Manage service board of the tickets generated by Automate.![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/image26.webp)  <br/><br/>  Navigate to the System Dashboard --> Config--> Information Base Categories to find the Id of the required ticket category. ![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/image27.webp)                                                   |
| NLA_Monitoring_Server_TicketCategory     | 163               | False    | This system property stores the ID of the `Ticket Category` to apply to the remote monitors created for the servers only. The default value is '0', i.e., `<Not Specified>`.![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/server_ticketcategory.webp)  <br/><br/> Ticket Categories are used to control the CW Manage service board of the tickets generated by Automate. Note: If this is set then the ticket category for the servers and workstations would be segregated.![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/image26.webp)  <br/><br/>  Navigate to the System Dashboard --> Config--> Information Base Categories to find the Id of the required ticket category. ![system_properties](../../../static/img/docs/c3e994ea-ed6d-4ae8-a4dc-0200d87208d5/image27.webp)                                                   |
