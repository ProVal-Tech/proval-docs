...
![Image1](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image1.png)

### Step 3  
Write the required configuration to display on the user's desktop.  
![Image2](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image2.png)

### Step 4  
Once your configuration file is written, Click on File option at the top right and Select `Save As`.  
![Image3](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image3.png)

### Step 5  
Save the file with an appropriate name and .bgi extension. Try avoiding spaces and special characters in the file name.  
![Image4](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image4.png)
...
![Image5](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image5.png)

### Step 7  
Open the script and save the exact name of the file under the global variable `bginame`.  
![Image6](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image6.png)
...
![Image7](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image7.png)  
...
![Image8](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image8.png)  

## Sample Run  

![Image9](../../../static/img/docs/405866fb-2706-49b3-aed2-3d1f1fea4b4b/Image9.png) 
