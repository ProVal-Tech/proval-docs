...
This script collects all the OST/PST file names and sizes from Windows machines and stores them in a custom table [pvl_outlook_pst_ost_audit](/docs/bea56cbb-3761-452a-9493-08a88bc6dbab).
...
- [Solution - Microsoft Outlook - OST/PST Audit](/docs/cefde8db-a69d-4d25-a5b2-dda08f468fb4)
