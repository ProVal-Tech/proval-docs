...
tags: ['automation', 'group', 'monitoring', 'database', 'setup', 'configuration']
draft: false
unlisted: false
---
## Summary
...
![Sample Run](5078775/docs/10606199/images/14720273)
...
1. Offline
   ...
   2. If group 'Machines with Queued Scripts' doesn't exist create it and move on.
   ...
   5. Check to see if the alert template exists, if it's not, create it.
   ...
   9. Check to see if the target script exists in the custom table for that target computer, if it isn't, add it to the custom table.
