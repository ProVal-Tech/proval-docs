...
This script is an Automate implementation of the agnostic script [Get-ChromiumExtensions](/docs/8828a709-4424-48f9-a5bf-dfc81a40bb97).
...
- Executes the agnostic script [Get-ChromiumExtensions](/docs/8828a709-4424-48f9-a5bf-dfc81a40bb97) and stores the data into a JSON file.
