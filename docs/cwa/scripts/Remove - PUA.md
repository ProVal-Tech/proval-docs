...
| Category      | MsftBloatApps                                | <ul><li>MsftBloatApps</li><li>ThirdPartyBloatApps</ul></li> | False      | Used with RemoveAll to filter bloatware to a certain category, allowing you to select just a specific category of bloatware.                                                        |
