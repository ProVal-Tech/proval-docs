...
A: Log in to [https://portal.threatlocker.com/](https://portal.threatlocker.com/). Navigate to **Modules → Application Control →** ![New Application](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image.webp) **→ New Application**. A new tab titled "Create Application" will open.

![Creating Application](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image2.webp)

**Creating the Application**
- The application name can be set to anything.  
![Application Name](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image3.webp)
  
- Set the application file hash as whitelisted.  
![Whitelist Application Hash](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image4.webp)  
![Whitelist Application Hash](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image5.webp)

- Click "Create Policy."
- Once the policy is created, launch it and set the application ID to the system property "ThreatLocker_ApplicationId."  
![Set Application ID](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image6.webp)
...
![GET /Reports Dependencies](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image7.webp)

- For `POST /MaintenanceMode`: MaintenanceMode AuthKey, ComputerId, ApplicationId, and Method must be set appropriately.  
![POST /MaintenanceMode Dependencies](/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image8.webp)
## Attachments
