...
## Sample Run
![Sample Run](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image_1.webp)
...
A: Log in to [https://portal.threatlocker.com/](https://portal.threatlocker.com/). Navigate to **Modules → Application Control →** ![New Application](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image.webp) **→ New Application**. A new tab titled "Create Application" will open.

![Creating Application](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image2.webp)

**Creating the Application**
- The application name can be set to anything.  
![Application Name](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image3.webp)
  
- Set the application file hash as whitelisted.  
![Whitelist Application Hash](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image4.webp)  
![Whitelist Application Hash](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image5.webp)

- Click "Create Policy."
- Once the policy is created, launch it and set the application ID to the system property "ThreatLocker_ApplicationId."  
![Set Application ID](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image6.webp)

- Enter it in **System → Dashboard → Config → Configurations → Properties** in Automate.  
![Enter in Automate](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image_2.webp)
...
![GET /Reports Dependencies](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image7.webp)

- For `POST /MaintenanceMode`: MaintenanceMode AuthKey, ComputerId, ApplicationId, and Method must be set appropriately.  
![POST /MaintenanceMode Dependencies](../../../static/img/docs/7dedea46-a8d7-4901-93c5-f2bb4c876f83/image8.webp)
## Attachments
