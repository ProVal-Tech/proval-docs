...
**Parameters Used:**  
![Set Parameters](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_1.png)

**Output:**  
![Set Output](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_2.png)

### Remove:
The Remove action can be used to remove the currently applied homepage from the concerned browser(s).

**Parameters Used:**  
![Remove Parameters](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_3.png)

**Output:**  
**Google Chrome:**  
![Remove Chrome Output](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_4.png)  
**Mozilla Firefox:**  
![Remove Firefox Output](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_5.png)  
**Microsoft Edge:**  
![Remove Edge Output](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_6.png)
...
**Parameters Used:**  
![Replace Parameters](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_7.png)

**Output:**  
![Replace Output](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_8.png)
...
![Set Chrome Homepage](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_9.png)

- Remove the Homepage from a single browser:  
Example: Removing the homepage from Mozilla Firefox:  
![Remove Firefox Homepage](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_10.png)
...
![Replace Edge Homepage](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_11.png)
...
![Replace Chrome and Firefox Homepage](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_12.png)
...
![Remove All Browsers Homepage](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_13.png)
...
![Enforce Homepage on Startup](../../../static/img/docs/770946a6-9399-4001-adc6-9d1eb9f203da/image_14.png)
