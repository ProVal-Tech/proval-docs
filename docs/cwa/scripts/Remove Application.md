...
![CMS Software Tile](5078775/docs/12578871/images/22164838)

![CMS Software Tile](5078775/docs/12578871/images/22164835)
...
![Command Prompt](5078775/docs/12578871/images/22164714)

Type or paste the command in the command prompt and press the `Enter` button on your keyboard to execute the command.

![Command Execution](5078775/docs/12578871/images/22165078)
![Command Execution](5078775/docs/12578871/images/22165165)

## Sample Runs

- Uninstall Google Chrome and do not create a ticket on failure.  
  **Name:** Google Chrome  
  ![Sample Run](5078775/docs/12578871/images/22165305)
...
- Uninstall Google Chrome, Microsoft OneDrive, VMWare Tools and create a ticket on failure.  
  ...
  **Enable_Ticketing:** `1`  
  ![Sample Run](5078775/docs/12578871/images/22165427)
...
**Example:**  
![Ticketing Example](5078775/docs/12578871/images/22165653)
