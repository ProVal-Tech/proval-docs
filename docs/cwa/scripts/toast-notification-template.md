...
| RebootButton             | 1                                                                                                                                                   |
| LearnMoreButton          | 1                                                                                                                                                   |
| LearnMoreUrl             | https://www.provaltech.com                                                                                            |
| SnoozeButton             | 0                                                                                                                                                   |
| DismissButtonText        | Dismiss                                                                                                                                             |
| TitleText                | Reboot Required                                                                                                                                     |
| AttributionText          | www.provaltech.com                                                                                                     |
| BodyText1                | An application is installed on your computer and it is required to reboot the machine ASAP. Click the Reboot button to restart your computer now.   |
| BodyText2                | Ignoring the notification is not suggested but you'll be notified hourly until your computer is restarted if ignored or clicking the Dismiss button.|
| LogoImage                | https://labtech.provaltech.com/labtech/transfer/images/alogo.jpg                                                                           |
| HeroImage                | https://labtech.provaltech.com/labtech/transfer/images/alogo.jpg                                                                          |
| Deadline                 | 2025-02-05 08:00:00                                                                                                                                 |
| NotificationAppName      |                                                                                                                                                     |
| MaxUptimeDays            | 0                                                                                                                                                   |
| ADPasswordExpirationDays | 0                                                                                                                                                   |
| Repeat                   | 60Minutes                                                                                                                                           |
