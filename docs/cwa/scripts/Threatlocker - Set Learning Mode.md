...
A: Login to [https://portal.threatlocker.com/](https://portal.threatlocker.com/). Navigate to **Modules → Application Control →** ![New Application](https://proval.itglue.com/5078775/docs/16557697/images/25890455) **→ New Application**. A new tab titled "Create Application" will open.
