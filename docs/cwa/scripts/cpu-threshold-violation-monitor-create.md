...
![Run Debug Script](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_4.png)  
![Run Debug Script](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_5.png)
...
1. **Remove Existing Monitors**
   ...
   - Open the `Server Status` tool by navigating to `Help` > `Server Status`.  
     ![Server Status Tool](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_1.png)
   - Click the `Do Group Refresh` button to refresh and apply the changes made.  
     ![Do Group Refresh](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_2.png)
   - Click `OK` to the popup message and wait for a minute to allow the changes to take effect.  
     ![Click OK](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_3.png)
...
5. **Reload System Cache**
   - Refresh the system cache to ensure all changes are updated.  
     ![Reload System Cache](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_6.png)
...
6. **Configure System Properties and EDFs**
   ...
   - Find the properties beginning with `CPU_Monitoring`.  
     ![Find Properties](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_7.png)
...
7. **Schedule the Script**
   - Schedule the script to run once per day, preferably around midnight, from the dashboard for optimal results.  
     ![Schedule Script](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_8.png)
...
| Name                                           | Example          | Required | Description                                                                                                                                                                                                                                                                                                                                 |
|------------------------------------------------|------------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CPU_Monitoring_Group_Ids                       | 2,3,855,85       | True     | The script will create remote monitors for the machines that belong to the groups identified by the group IDs specified in this system property. The monitor set will not be associated with the groups themselves but with the individual machines. Multiple IDs can be included by separating them with a comma. The default value is `0`. <br />![Image1](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image1.png) |
| CPU_Monitoring_Server_Only                     | 0                | False    | Setting this system property to `1` will limit the monitor set creation to the Windows Servers only. The default value is `0`. Also, the script will remove the monitor set created for the Windows Workstations after setting this property to `1`. <br />![Image2](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image2.png) |
| CPU_Monitoring_Workstation_Only                 | 0                | False    | Setting this system property to `1` will limit the monitor set creation to the Windows Workstations only. The default value is `0`. Also, the script will remove the monitor set created for the Windows Servers after setting this property to `1`. <br />![Image3](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image3.png) |
| CPU_Monitoring_Exclude_Virtual_Machines        | 0                | False    | Setting this system property to `1` will limit the monitor set creation to the Physical Windows Machines only. The default value is `0`. Also, the script will remove the monitor set created for the Virtual Machines after setting this property to `1`. <br />![Image4](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image4.png) |
| CPU_Monitoring_Interval                         | 300              | True     | Controls the generated Remote Monitor run time interval. The default is 300 seconds.  <br />![Image5](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image5.png) <br />![Image6](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image6.png) |
| CPU_Monitoring_Server_Continuous_Usage_Threshold_Minutes | 30    | True     | This property determines the duration in minutes during which servers must consistently exhibit high CPU usage before triggering an alert. By default, this duration is set to `30` minutes. In other words, alerts will be generated for remote monitors on servers only if they surpass the high CPU usage threshold and remain above the low CPU usage threshold for more than `30` minutes consecutively. <br />![Image7](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image7.png) |
| CPU_Monitoring_Workstation_Continuous_Usage_Threshold_Minutes | 30    | True     | This property determines the duration in minutes during which workstations must consistently exhibit high CPU usage before triggering an alert. By default, this duration is set to `30` minutes. In other words, alerts will be generated for remote monitors on workstations only if they surpass the high CPU usage threshold and remain above the low CPU usage threshold for more than `30` minutes consecutively. <br />![Image8](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image8.png) |
| CPU_Monitoring_Server_High_Threshold_Percentage | 95               | True     | This property stores the upper threshold, expressed as a percentage, for CPU usage on servers. The upper threshold is the CPU usage percentage that triggers the timer. Once the CPU usage hits the upper threshold, the monitor set initiates a timer and monitors it until the CPU usage drops below the lower threshold. If the CPU usage remains above the lower threshold for the duration specified in the `CPU_Monitoring_Server_Continuous_Usage_Threshold_Minutes` property, an alert will be generated. The default value is `95`. <br />![Image9](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image9.png) |
| CPU_Monitoring_Workstation_High_Threshold_Percentage | 90           | True     | This property stores the upper threshold, expressed as a percentage, for CPU usage on workstations. The upper threshold is the CPU usage percentage that triggers the timer. Once the CPU usage hits the upper threshold, the monitor set initiates a timer and monitors it until the CPU usage drops below the lower threshold. If the CPU usage remains above the lower threshold for the duration specified in the `CPU_Monitoring_Workstation_Continuous_Usage_Threshold_Minutes` property, an alert will be generated. The default value is `90`. <br />![Image10](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image10.png) |
| CPU_Monitoring_Server_Low_Threshold_Percentage  | 90               | True     | This property stores the lower threshold, expressed as a percentage, for CPU usage on servers. The lower threshold is the CPU usage percentage that stops the timer. Once the CPU usage goes below the lower threshold, the monitor set stops the timer initiated after hitting the higher threshold stored in the `CPU_Monitoring_Server_High_Threshold_Percentage` property. The monitor set will auto-close the ticket after the CPU usage for the server drops below the percentage stored in this system property. The default value is `90`. <br />![Image11](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image11.png) |
| CPU_Monitoring_Workstation_Low_Threshold_Percentage | 85            | True     | This property stores the lower threshold, expressed as a percentage, for CPU usage on workstations. The lower threshold is the CPU usage percentage that stops the timer. Once the CPU usage goes below the lower threshold, the monitor set stops the timer initiated after hitting the higher threshold stored in the `CPU_Monitoring_Workstation_High_Threshold_Percentage` property. The monitor set will auto-close the ticket after the CPU usage for the workstation drops below the percentage stored in this system property. The default value is `90`. <br />![Image12](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image12.png) |
| CPU_Monitoring_Server_AlertTemplate             | 1                | True     | This system property stores the id of the `Alert Template` to apply to the remote monitors created for the servers. The default value is `1`, i.e., `Default - Do Nothing.` <br />![Image13](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image13.png) <br /><br />Navigate to the **System Dashboard --> Management --> Alert Templates** to find the Id of the required alert template. <br />![Image14](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image14.png) <br /><br />It is suggested to use the `△ Custom - Ticket Creation - Computer` alert for better alerting. The alert template should not be running the very same script for the Warning action as well unless you want to create a ticket for the PowerShell errors too. <br />![Image15](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image15.png) |
| CPU_Monitoring_Workstation_AlertTemplate        | 1                | True     | This system property stores the id of the `Alert Template` to apply to the remote monitors created for the workstations. The default value is `1`, i.e., `Default - Do Nothing.` It is suggested to use the `△ Custom - Ticket Creation - Computer` alert for better alerting. The alert template should not be running the very same script for the Warning action as well unless you want to create a ticket for the PowerShell errors too. <br />![Image16](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image16.png) |
| CPU_Monitoring_Server_TicketCategory            | 124              | False    | This system property stores the id of the `Ticket Category` to apply to the remote monitors created for the Servers. The default value is `0`, i.e., `<Not Specified>`. <br />![Image17](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image17.png) <br /><br />Ticket Categories are used to control the CW Manage service board of the tickets generated by Automate. <br />![Image18](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image18.png) <br /><br />Navigate to the **System Dashboard --> Config --> Information Base Categories** to find the Id of the required ticket category. <br />![Image19](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image19.png)|
| CPU_Monitoring_Workstation_TicketCategory       | 125              | False    | This system property stores the id of the `Ticket Category` to apply to the remote monitors created for the Workstations. The default value is `0`, i.e., `<Not Specified>`. <br />![Image20](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image20.png)|

![Image21](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image21.png)
...
![Image23](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image23.png)  
![Image24](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image24.png)
...
![Image22](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image22.png)
...
![Image25](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image25.png)  
![Image26](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image26.png)
...
![Sample Ticket](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_9.png)  
![Sample Ticket](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_10.png)

**Sample Remote Monitor:**

![Sample Remote Monitor](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_11.png)  
![Sample Remote Monitor](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_12.png)  
![Sample Remote Monitor](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_13.png)  
![Sample Remote Monitor](../../../static/img/docs/20b0f192-7315-42d9-a575-9e088c15d79c/image_14.png)  
