...
tags: ['vulnerability', 'remediation', 'detection', 'monitoring', 'logging', 'report', 'windows']
draft: false
unlisted: false
---
## Summary
...
| Detection-Remediation     | This collects data from client-EDF 'SMBv1 Enabled Detection and Remediation' for the agent where the script is deployed. If it is 1, then the SMBv1 Enabled will be detected, if found enabled then attempt to disable it and log the result to the dataview. |
...
|-------------------------------------------|-----------|----------|---------------------------|----------------------------------------------------------------------------------------------------------|
| SMBv1 Status                              | Computer  | Text     | Remediation Successful     | This stores the status of SMBv1 status after script execution.                                          |
