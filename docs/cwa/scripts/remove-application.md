...
![CMS Software Tile](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_1.png)

![CMS Software Tile](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_2.png)
...
![Command Prompt](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_3.png)

Type or paste the command in the command prompt and press the `Enter` button on your keyboard to execute the command.

![Command Execution](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_4.png)
![Command Execution](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_5.png)

## Sample Runs

- Uninstall Google Chrome and do not create a ticket on failure.  
  **Name:** Google Chrome  
  ![Sample Run](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_6.png)
...
- Uninstall Google Chrome, Microsoft OneDrive, VMWare Tools, and create a ticket on failure.  
  ...
  **Enable_Ticketing:** `1`  
  ![Sample Run](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_7.png)
...
**Example:**  
![Ticketing Example](../../../static/img/docs/201f46d7-6511-4e5f-a002-ff7f4b27c8be/image_8.png)
