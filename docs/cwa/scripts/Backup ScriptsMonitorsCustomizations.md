...
| Backup_Bitlocker_Audit_Data       | 1                                      | False    | Setting this system property to `1` will enable the backup of the `\<a href="https://proval.itglue.com/DOC-5078775-8946167">Bitlocker Status\</a>` dataview. The default value is `1` |
