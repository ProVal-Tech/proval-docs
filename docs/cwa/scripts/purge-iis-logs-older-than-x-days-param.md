...
![Sample Run Image](../../../static/img/docs/a7a7e04e-384d-4018-87c5-6abf2d2b2fb2/image_1.png)  

Preferred is to schedule the script against the "Labtech Server" to run once per week:  
![Schedule Image](../../../static/img/docs/a7a7e04e-384d-4018-87c5-6abf2d2b2fb2/image_2.png)  
