...
- **Tickets** - Requires [CWM - Automate - Script - Automate Database Maintenance Solution](<./Automate Database Maintenance Solution.md>) TicketCleanup_Days Global Variable set to other than 0
- **TicketData** - Requires [CWM - Automate - Script - Automate Database Maintenance Solution](<./Automate Database Maintenance Solution.md>) TicketDataAdditoinalCleanup_Days set to other than 0
