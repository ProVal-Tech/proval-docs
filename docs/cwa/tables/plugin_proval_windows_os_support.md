...
1. Open the article in a new tab.  
   ...
   ![](5078775/docs/7780690/images/22952623)  
   ![](5078775/docs/7780690/images/22952625)  
...
2. Click the `Edit` button.  
   ![](5078775/docs/7780690/images/22952673)  

3. Click `Edit` to start editing the document.  
   ![](5078775/docs/7780690/images/22952687)  
...
4. Connect to our internal database from a `Heidi SQL` client and execute this SQL query.  
   ...
   ```  
   ![](5078775/docs/7780690/images/22952733)  

5. Press `Ctrl + A` in the result section to select all rows.  
   ![](5078775/docs/7780690/images/22952773)  
