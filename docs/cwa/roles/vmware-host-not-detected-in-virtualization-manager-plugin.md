...
3. Confirm that the VMware host's IP address appears under **Network Devices** in the client section of the **Control Center**.
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_1.png)
...
4. If it does not, correct the IP range being scanned by the probe from the **Network Probe** tile > **Settings**. Once these settings have been modified, click **Save** and then click **Rescan Network**.
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_2.png)
...
5. Confirm that you have configured the proper credentials for the VMware host. This can be done from the **Global Settings**.
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_3.png)
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_4.png)
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_5.png) 
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_6.png)  
...
4. Try to manually apply the credentials to the network device itself and run a test through the network device.
   ...
   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_7.png)

   ![Image](../../../static/img/docs/132a68a2-5d49-49b5-994f-4baf4606f816/image_8.png)
