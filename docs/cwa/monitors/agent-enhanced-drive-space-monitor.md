...
![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_1.webp)  

The groups should have `MSP Contract Group` EDF marked  
![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_2.webp)
...
![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_3.webp)  
...
**Example:**  
![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_4.webp)  
...
**Example:**  
![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_5.webp)  
...
- The ticket will be created by the [Enhanced Disk Space Monitoring Process](/docs/8efd9cc2-b054-4dda-a690-bbe1d4bd16b3) script and the ticket category can be set at the following levels:
  ...
  - At the group level. The ticket category can be set from the groups where the internal monitor is applied. This ticket category will only be picked if global variables are set to 0.  
    ![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_7.webp)
  - On the global monitor set. The ticket category can be selected at the monitor set itself. This ticket category will only be picked if the group level ticket category is not defined and global variables are set to 0.  
    ![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_8.webp)
  - If the ticket category is not set from any of the above-mentioned places, then the ticket will be generated under the default ticket category.  
    ![image](../../../static/img/docs/f7235a0b-b6b6-456d-8af3-bd3471b1e70f/image_9.webp)
