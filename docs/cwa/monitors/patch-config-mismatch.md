...
This internal monitor detects machines where the data returned by the [Get Patch Config](/docs/c1b906ec-7aea-41f3-8241-358d3d644900) script does not match the settings defined by the [Patch Manager - WUA Settings Validation](/docs/1f78325c-968a-4a73-ba85-2a18c061063e) script.
