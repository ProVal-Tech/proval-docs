...
tags: ['configuration', 'setup', 'windows', 'alert', 'monitoring']
draft: false
unlisted: false
---
## Steps
...
### 1.
Import the Alert Template `△ Custom - Ticket Creation Computer - Failures Only`. The alert template should not perform any action. Import the Alert Template `△ Custom - Ticket Creation Computer - Failures Only`. The alert template should not perform any action.
