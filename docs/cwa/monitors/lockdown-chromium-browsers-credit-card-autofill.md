...
![Google Chrome Setting](../../../static/img/docs/bdd9f759-2636-4a76-ae7e-8cae7a4e874b/image_1.png)

**Affected Settings for Microsoft Edge:**  
![Microsoft Edge Settings](../../../static/img/docs/bdd9f759-2636-4a76-ae7e-8cae7a4e874b/image_2.png)

**Affected Setting for Brave:**  
![Brave Setting](../../../static/img/docs/bdd9f759-2636-4a76-ae7e-8cae7a4e874b/image_3.png)
...
Using any alert templates is not recommended unless the partner specifically desires an alert for failures. The remote monitor records both its successes and failures in the [Chromium Browsers Credit Card Lockdown - Status](/docs/cf2a1fb5-3667-4c4a-b0c8-2a600f191980) dataview.

| Check Action | Server Address | Check Type | Execute Info | Comparator | Interval | Result |
|--------------|----------------|------------|---------------|------------|----------|--------|
| System       | 127.0.0.1     | Run File   | **REDACTED**  | State Based | 604800 (Weekly) | Screenshot attached below. |

![Screenshot](../../../static/img/docs/bdd9f759-2636-4a76-ae7e-8cae7a4e874b/image_4.png)
...
**Dataview:** [EPM - Dataview - Chromium Browsers Credit Card Lockdown - Status](/docs/cf2a1fb5-3667-4c4a-b0c8-2a600f191980)

## Target

**Group:** △ Lockdown Browsers Password Manager  
![Target Group](../../../static/img/docs/bdd9f759-2636-4a76-ae7e-8cae7a4e874b/image_5.png)
