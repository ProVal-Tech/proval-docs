...
2. The antivirus software in question is in fact installed; however, the uninstallation registry key for WindowsComponent is set to 1, which is hiding the software from the add/remove programs list as well as the automate software list.
