...
- Does this monitor can create ticket during installation failure?
  
  Yes, you just need to set the ticket category at the monitor level to receive failure installation ticket.
