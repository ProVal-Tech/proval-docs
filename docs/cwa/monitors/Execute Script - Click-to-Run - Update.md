...
tags: ['windows', 'update', 'configuration', 'software', 'notification']
draft: false
unlisted: false
---
## Summary
...
Also, the "Microsoft Office - Click-to-Run - Update (ScriptState)" is a version of [SWM - Script - Microsoft Office - Click-to-Run - Update](https://proval.itglue.com/DOC-5078775-8141293) script, just it saves the script state which is being used in this monitor.

## Dependencies

["Microsoft Office - Click-to-Run - Update (ScriptState)" script](https://proval.itglue.com/DOC-5078775-14166219) which is a version of [SWM - Script - Microsoft Office - Click-to-Run - Update](https://proval.itglue.com/DOC-5078775-8141293) script.
