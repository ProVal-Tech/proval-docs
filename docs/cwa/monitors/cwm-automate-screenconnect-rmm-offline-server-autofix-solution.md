...
2. Reload the system cache:
   ![Cache Reload](../../../static/img/docs/c53aa0aa-4c52-4cd7-9971-f99662b4cbec/image_1.png)
...
- `△ Custom - Default Ticket - Autofix - Critical Machine Offline (RMM+)`
  ...
  ![Default Ticket Example](../../../static/img/docs/c53aa0aa-4c52-4cd7-9971-f99662b4cbec/image_2.png)
...
- `△ Custom - Autofix - Critical Machine Offline (RMM+)`
  ...
  ![Autofix Ticket Example](../../../static/img/docs/c53aa0aa-4c52-4cd7-9971-f99662b4cbec/image_3.png)
...
2. **What are the differences between the two tickets, and how do they look?**
   - For the Default Ticket creation alert template, the initial description should look something like this:
     ![Default Ticket Description](../../../static/img/docs/c53aa0aa-4c52-4cd7-9971-f99662b4cbec/image_4.png)

   - For the ticket creation from the script, the initial description should look something like this:
     ![Script Ticket Description](../../../static/img/docs/c53aa0aa-4c52-4cd7-9971-f99662b4cbec/image_5.png)
