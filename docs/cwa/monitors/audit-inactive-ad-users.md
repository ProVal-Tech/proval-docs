...
- [Script - Disable - Audit AD Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa)
...
- Import the monitor `ProVal Production - Detect Audit AD Users`.
- Ensure the - [Script - Audit - Inactive AD Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa) is imported.
- Import the  `Alert Template - △ Custom - Execute Script - Audit Inactive AD Users`

- Apply the alert template `△ Custom - Execute Script - Audit Inactive AD Users` to the monitor that calls the [Script - Audit - Inactive AD Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa) to disable the detected accounts.