...
tags: ['alert', 'configuration', 'monitoring', 'ticket', 'sql']
draft: false
unlisted: false
---
## Steps
...
### 1.
Ensure the presence of [CWM - Automate - Script - Ticket Creation - Computer](https://proval.itglue.com/DOC-5078775-9098338) script and `△ Custom - Ticket Creation Computer - Failures Only` alert template.
