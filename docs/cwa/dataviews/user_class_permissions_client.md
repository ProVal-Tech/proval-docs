---
id: 'af60f4a6-c13c-4fc9-b488-263ce5c38485'
slug: /af60f4a6-c13c-4fc9-b488-263ce5c38485
title: 'User Class Permissions - Client'
title_meta: 'User Class Permissions - Client'
keywords: ['view', 'userclass', 'windows', 'dataview', 'sql']
description: 'This dataview displays the type of permissions applied to each user class on a client level.'
...
## Summary
This dataview displays the type of permissions applied to each user class on a client level.
