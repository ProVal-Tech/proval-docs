...
[Approval Policy - Auto Approve/Ignore/Deny Audit](<./Approval Policy - Auto ApproveIgnoreDeny Audit.md>) dataview should be reviewed in order to understand the exact purpose of this one.
