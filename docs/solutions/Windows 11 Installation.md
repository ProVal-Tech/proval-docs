...
- [Windows 11 Upgrade Failure [Ticket]](../cwa/scripts/windows-11-upgrade-failure.md)  
- [Install Windows 11 Feature Update [Beta, Reboot]](../cwa/scripts/install-windows-11-feature-update-beta-reboot.md)
...
| [Windows 11 Installation Audit [Compatible Machines]](<../cwa/dataviews//Windows 11 Installation Audit [Compatible Machines].md>)  | Dataview        | Displays the outcome of automation.                                    |
...
| [Install Windows 11 Feature Update [Beta, Reboot]](../cwa/scripts/install-windows-11-feature-update-beta-reboot.md) | Script | Workaround script for erroneous machines |
...
2. Import the following content using the ProSync Plugin:  
    ...
    - [Script: Windows 11 Upgrade Failure [Ticket]](../cwa/scripts/windows-11-upgrade-failure.md)  
    - [Script: Install Windows 11 Feature Update [Beta, Reboot]](../cwa/scripts/install-windows-11-feature-update-beta-reboot.md)
...
5. Schedule the [Script: Windows 11 Upgrade Failure [Ticket]](../cwa/scripts/windows-11-upgrade-failure.md) script to run once per day.  
