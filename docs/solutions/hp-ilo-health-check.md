...
|-------------------------------------------------------------------------------------------------------------|-----------------|-----------------------------------------------------------------------------------------------------------------------|
| [HP iLO - Health Report - Get](/docs/f28ef90e-ba80-4ba1-9bd6-e4aa4c2b549a)                | Script          | Calls the agnostic script and formats the data for SQL.                                                               |
| [Execute Script - HP iLO - Health Report - Get](/docs/a8f66140-8915-41fa-805b-64fafbf002fc) | Internal Monitor | Executes the [HP iLO - Health Report - Get](/docs/f28ef90e-ba80-4ba1-9bd6-e4aa4c2b549a) script against the relevant computers to keep the dataview up-to-date. |
...
| [HP iLO Health Report](/docs/163aca22-cc56-45ee-9732-3873c6117e60)                            | Dataview        | Displays information gathered by the [HP iLO - Health Report - Get](/docs/f28ef90e-ba80-4ba1-9bd6-e4aa4c2b549a) script. |
| [HP iLO Checks Not Running](/docs/90498d55-eb8d-45cb-8ea0-90e1729fefc4)                  | Dataview        | Lists the password entries for which the HP iLO Health Check automation is not running properly.                    |

#### Automation

| Content                                                                                                     | Type               | Function                                                                                                              |
|-------------------------------------------------------------------------------------------------------------|--------------------|-----------------------------------------------------------------------------------------------------------------------|
| [HP iLO Health Report Check](/docs/9f991e6a-9560-46ee-a9cc-29e401f000e0)                   | Internal Monitor    | Monitors for bad health status information stored in the [plugin_proval_ilo_health_report](/docs/d6e5e2a7-ecb8-4262-92a1-cc322b4af3b6) custom table. |
| [Ticket Creation - HP iLO Health Check*](/docs/5c6b4bbb-732d-4d97-af38-f10d51a8a96c) | Script              | Manages ticketing for the [HP iLO Health Report Check](/docs/9f991e6a-9560-46ee-a9cc-29e401f000e0) monitor set.  |
...
1. Import the following scripts from the `ProSync` plugin:
   ...
   - [Ticket Creation - HP iLO Health Check*](/docs/5c6b4bbb-732d-4d97-af38-f10d51a8a96c)
   - [HP iLO Credential Missing Detection](/docs/4d27ff0e-704d-47dd-8c07-3008b7fbfafb)

2. Import the following internal monitors from the `ProSync` plugin:
   - [Execute Script - HP iLO - Health Report - Get](/docs/a8f66140-8915-41fa-805b-64fafbf002fc)
   - [HP iLO Health Report Check](/docs/9f991e6a-9560-46ee-a9cc-29e401f000e0)
...
4. Import the following dataviews from the `ProSync` plugin:
   - [HP iLO Health Report](/docs/163aca22-cc56-45ee-9732-3873c6117e60)
   - [HP iLO - Potentially Missing Credential](/docs/0abb04f1-450d-4185-9ecd-f27a842cf658)
   - [HP iLO Checks Not Running](/docs/90498d55-eb8d-45cb-8ea0-90e1729fefc4)

5. Reload the System Cache.  
   ![Reload System Cache](../../static/img/docs/7bd9dad1-d463-468b-a3b1-2eef8e060352/image_1.webp)

6. Execute the [HP iLO - Health Report - Get](/docs/f28ef90e-ba80-4ba1-9bd6-e4aa4c2b549a) script against an online Windows machine with the `RecreateTable` parameter set to `1` to create the [plugin_proval_ilo_health_report](/docs/d6e5e2a7-ecb8-4262-92a1-cc322b4af3b6) custom table.  
