...
[cPVAL - Server Role - SMB1 Server](/docs/d57f8cfb-bb1e-4e9a-bf22-9bb24a35817f)  | Infrastructure Master                           | `Custom Field` [cPVAl Roles Detected](/docs/e9ec73dd-98b1-4436-a027-4ee8906f7cba) `Contains` `SMB1 Server`                           | A group tailored for Windows Servers that have the `SMB1 Server` role installed   
