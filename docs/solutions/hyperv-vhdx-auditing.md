...
2. Create the [Server Roles Detection and Grouping for NinjaOne](/docs/56ed4b40-11ce-4f8d-b1ca-c897d2c496e6) custom field.
...
**A:** The example uses a daily schedule; the sample task runs the automation at `02:00 PM` each day.
