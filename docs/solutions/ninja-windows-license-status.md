...
| [Windows License Issue Detected](/docs/c26e9e39-1e15-44fa-acfe-0deae7c10cdb) | Compound Condition | This compound condition detects the Windows workstations agent where the license status is `Unlicensed` or `NonGenuineGrace`. |
| [Windows License Issue Detected](/docs/898da82d-b3db-4402-b15d-d62a72dab942) | Compound Condition | This compound condition detects the Windows server agent where the license status is `Unlicensed` or `NonGenuineGrace`. |
