...
|----------------------------------|-------------------------------|--------------------------------------------------------|
|  [Get Local Administrators](/docs/11f555cc-79ab-464f-87af-b46c324990ee)    | Script | This Script lists the local administrators on windows machine and stores the result in a custom field. |
|  [Localgroup Admins  ](/docs/03f2a420-5c70-4078-8b71-dc0fd7f6895d)    | Custom Field | This custom field contains the List of Local Group Admins on the machine fetched by script [Get Local Administrators](/docs/11f555cc-79ab-464f-87af-b46c324990ee)   |
...
|  [Machines Opted for LocalAdmin Detection ](/docs/e1cb7e20-f09c-4350-a496-db920efa6530)    | Group |Select this Custom Field to exclude an endpoint from Local Admin Detection Solution. |

## Implementation

- Create  below custom fields:
    - [Localgroup Admins  ](/docs/03f2a420-5c70-4078-8b71-dc0fd7f6895d)
