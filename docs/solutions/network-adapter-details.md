...
| [custom Field - cPVAL Network Adapter Details](/docs/fb89116d-060f-4787-95af-efdd731765d2) | `Custom Field`      | Displays all network adapter–related custom fields, including `DHCP status`, `IP type`, and `DNS server` address             |
