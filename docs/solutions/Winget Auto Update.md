...
|-------------------------------------------------------------------------|---------------|---------------------------------------------------------------------------------------------------|
| [Winget App Audit](https://proval.itglue.com/DOC-5078775-17973895)    | Script        | Fetches information about the installed winget-supported applications from the endpoint.         |
...
| [Execute Script - Configure Winget Auto Update](<../cwa/monitors/Execute Script - Configure Winget Auto Update.md>) | Internal Monitor | Detects Windows computers where the [Configure Winget Auto Update](https://proval.itglue.com/DOC-5078775-17973896) script needs to be executed. |
