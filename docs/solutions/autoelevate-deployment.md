...
### 2. Are the custom fields (`cPVAL AutoElevate LicenseKey, cPVAL AutoElevate CompanyName, cPVAL AutoElevate LocationName, cPVAL AutoElevate ElevationMode, cPVAL AutoElevate BlockerMode`) mandatory for deployment?
