...
|-------------------------------------------------------------------------|-----------------|---------------------------------------------------------------------------------------------------------------------|
| [Monitor - Missing Vendor Admin Software](<../cwa/monitors/Missing Dell OpenManage Software.md>) | Internal Monitor | Detects the HP servers which are missing the `HPE Insight Management Agents` application.                          |
...
| [Solution - HP iLO Health Check](<./HP iLO Health Check.md>) | Solution         | Gather information about and monitor the health status of HP iLO devices.                                         |
