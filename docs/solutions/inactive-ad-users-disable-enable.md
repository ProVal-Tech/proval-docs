...
|-----------------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------|
| [Disable - AD Inactive Users - X Days](/docs/b793791e-2305-4ac5-ace3-b5737368190e) | Script | This script detects the inactive users over `Property - Inactive_AD_Users_Threshold_Days` days and disables them, and records the data into the [Table - pvl_ad_inactive_users](/docs/2b118df6-1fef-4530-9303-0bb56c478361) so that it can be represented in a [Dataview - AD Inactive Users Audit](/docs/9c9888a7-678a-497f-8f61-11e21e020999) |
...
| [Audit - AD Inactive Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa) | Script | This script detects the inactive users over `Property - Inactive_AD_Users_Threshold_Days` days and records the data into the [Table - pvl_ad_inactive_users](/docs/2b118df6-1fef-4530-9303-0bb56c478361) so that it can be represented in a [Dataview - AD Inactive Users Audit](/docs/9c9888a7-678a-497f-8f61-11e21e020999). |
...
- Import the [Script - Audit - AD Inactive Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa)
    It is needed to run this script during import with `SetEnvironment` = 1, to create the [Table - pvl_ad_inactive_users](/docs/2b118df6-1fef-4530-9303-0bb56c478361), import the required EDFs,and import the required system property `Property - Inactive_AD_Users_Threshold_Days`. Refer to the [Script - Audit - AD Inactive Users - X Days](/docs/cd2a8419-a43c-46ea-ba52-8b9b6c0a01fa) for a sample run demonstration and also check on how the EDFs are used.
- Reload the cache
