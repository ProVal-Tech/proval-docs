...
|-----------------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------|
| [cPval Excluded Domain Admin](/docs/32a5e5bb-b72e-4597-beae-8f2d8a2eb1c0)   | Custom Field | Stores the usernames to exclude from generating the new domain admin detected ticket |
...
- Create the [Custom Field : cPval Excluded Domain Admin](/docs/32a5e5bb-b72e-4597-beae-8f2d8a2eb1c0) using the implementation instruction provided in the document.
