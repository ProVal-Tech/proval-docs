...
1. Open the Webroot SecureAnywhere with Unity plugin.  
   ![Webroot Plugin](../../static/img/docs/70bf86a4-3ddf-46b1-947d-e2dc580209a5/image_1.png)

2. Right-click the client to configure and assign the associated Webroot site.  
   ![Webroot Client Configuration](../../static/img/docs/70bf86a4-3ddf-46b1-947d-e2dc580209a5/image_2.png)  
   ![Webroot Client Configuration](../../static/img/docs/70bf86a4-3ddf-46b1-947d-e2dc580209a5/image_3.png)
