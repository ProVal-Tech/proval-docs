...
| [Execute - Office Cleanup and M365 Deployment](/docs/e3c064d1-452d-465f-a8d5-e09858fd6aad)    | Compound condition | Executes the [Script - Office Cleanup and M365 Deployment](/docs/de0e7e1f-6f29-41b2-9d65-164b2e2c4431) only when 'cPVAL Enable Office Cleanup and M365 Deployment' is set to Enable. |
