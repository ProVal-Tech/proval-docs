...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [CWM - Automate - Role - Internet Explorer Installed](/docs/c48b8ff6-9189-49b2-bd2a-442fb26e7bbe)                                                            | Role            | The purpose of this Role is to detect the machines where the Internet Explorer feature is enabled.                                                                                                                           |
| [CWM - Automate - Internal Monitor - ProVal - Development - Internet Explorer Detected [Role]](/docs/1c9a68c5-62c9-4454-a6da-0a7c5fb8089d)                  | Internal Monitor | The purpose of this Internal Monitor is to detect the online machines where the [CWM - Automate - Role - Internet Explorer Installed](/docs/c48b8ff6-9189-49b2-bd2a-442fb26e7bbe) role is detected.                      |
| [CWM - Automate - Script - Internet Explorer - Disable [Global, DV, Autofix]](/docs/60cf67bf-fc28-4461-a2ad-7a32b2461652)                                   | Script          | The purpose of this script is to disable Internet Explorer.                                                                                                                                                                  |
| ~Autofix - Disable Internet Explorer                                                                                                                              | Alert Template   | This alert template is responsible for executing the [CWM - Automate - Script - Internet Explorer - Disable [Global, DV, Autofix]](/docs/60cf67bf-fc28-4461-a2ad-7a32b2461652) script on all machines detected by the [CWM - Automate - Internal Monitor - ProVal - Development - Internet Explorer Detected [Role]](/docs/1c9a68c5-62c9-4454-a6da-0a7c5fb8089d) monitor set. |
