...
| [cPVAL DUO USERNAMEFORMAT](/docs/ca662111-e0a5-4318-8615-a00341257a1c) | `Organization` | False | Drop-down | `Windows`, `Windows Workstations`, `Windows Servers`, `Disabled` | `Windows` | Specifies the username format sent to Duo: sAMAccountName, NTLM domain\username, or userPrincipalName. |
