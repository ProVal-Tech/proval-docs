...
|---------------------------------------------------------------------------------------------|---------------|-------------------------------------------------------------------------------------------------------|
| [Remote Monitor - NTLMv1.1 Detection](<../cwa/monitors/NTLMv1.1 Detection.md>)     | Remote Monitor| Check whether the NTLMv1.1 is enabled on the end machine or not.                                     |
| [Dataview - NTLMv1.1 Status [Remote Monitor]](<../cwa/dataviews/NTLMv1.1 Status Remote Monitor.md>) | Dataview      | Represents If NTLMv1.1 is enabled or not. It is dependent on the [EPM - Windows Configuration - Remote Monitor - NTLMv1.1 Detection](<../cwa/monitors/NTLMv1.1 Detection.md>). |
