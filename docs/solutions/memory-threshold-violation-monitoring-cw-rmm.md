...
keywords: ['memory', 'monitoring', 'windows', 'alerts', 'thresholds', 'performance', 'workflow', 'trigger', 'bot', 'device-association']
...
9. Import the [Memory Threshold Violation Monitoring [Workflow]](/docs/029c88f9-1655-4919-8c25-873ad4b53ca0) monitor.
