...
| SonicWall NetExtender Deployment                                                              | Client-EDF      | This EDF needs to be checked for the monitor to detect the clients where the SonicWall NetExtender deployment is needed on their agents.  ![Client EDF](../../static/img/docs/sonicwall-netextender-installupdate/image-2.png)                                                                                                                                                                                              |
| SonicWall NetExtender Exclude                                                                 | Location-EDF    | This EDF check at the location level will exclude the agents of the locations from the SonicWall NetExtender deployment.  !![Location EDF](../../static/img/docs/sonicwall-netextender-installupdate/image-3.png)                                                                                                                                                                                                                               |
| SonicWall NetExtender Exclude                                                                 | Computer-EDF    | This EDF check will exclude the agents from the SonicWall NetExtender deployment.  ![Computer EDF](../../static/img/docs/sonicwall-netextender-installupdate/image-4.png)                      |
...
6. Run the [Monitor - SonicWall NetExtender - Install/Update](/docs/b0ca57d2-351c-4f1d-9d98-954c1d77777e). and ensure the script populates the system property.  
   ...
   ![Property](../../static/img/docs/sonicwall-netextender-installupdate/image-5.png)
