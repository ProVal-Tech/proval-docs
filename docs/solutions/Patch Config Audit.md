...
tags: ['windows', 'audit', 'monitor', 'configuration', 'automation']
draft: false
unlisted: false
---
## Purpose
...
| △ Custom - Patch Config Mismatch<br>                                                                  | Alert Template  | Executes [Patch Manager - WUA Settings Validation](https://proval.itglue.com/DOC-5078775-9135620) script. |
