...
| --- | --- | --- | --- |
| [TLS_SSL_Enabled_Protocols](/docs/a90fed7d-ec54-429a-a7cf-14a1af8870bb) | Endpoint | Text Box | Comma‑separated list of the TLS/SSL protocol versions currently enabled on the device, read from the live registry after hardening. Written by the task and read by the compliance group; not user‑editable. |
