...
The purpose of this solution is to present a detailed analysis of script failures over the past 30 days. The solution is created to overcome the limitation of the [Script Failure Assessment](<../cwa/dataviews/Script Failure Assessment.md>) dataview.
