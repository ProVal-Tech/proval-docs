...
|----------------------|-----------------------------|--------------------|
| [Disable AutoPlay AutoRun Policy](/docs/6edf4c00-78eb-4b46-8d5b-a69468c7cb7b) | Custom Field | Custom Field to enable the solution. Select this Custom Field to apply settings that disables AutoRun and AutoPlay policies across the client's Windows devices. |
