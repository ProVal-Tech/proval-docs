...
| [Exclude AutoPlay AutoRun Disable](/docs/e23af607-09ff-44f8-887c-277aff979040b) | Custom Field | Custom field to exclude the Site/Endpoint from AutoPlay/AutoRun disablement. |
...
- Create the [Disable AutoPlay AutoRun Policy](/docs/4b9dbdd3-f4f4-4f3e-bc09-51aaa16000c9) as per instructions provided in the documents.
- Create the [Disable Autorun/Autoplay Policy](/docs/6399c6ed-3a31-4d9e-97ce-9ca50780bb92) as per instructions provided in the documents.
- Schedule the script to target  [Disable AutoPlay AutoRun Policy](/docs/4b9dbdd3-f4f4-4f3e-bc09-51aaa16000c9) to start disabling the policies.
