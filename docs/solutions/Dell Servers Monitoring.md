...
|-------------------------------------------------------------------------------------------------|-----------------|--------------------------------------------------------------------------------------------------------------|
| [EPM - Vendor Specific - Monitor - Missing Dell OpenManage Software](<../cwa/monitors/Missing Dell OpenManage Software.md>) | Internal Monitor | Detects the Dell servers which are missing the `Dell OpenManage System Management Software` application.     |
| [Remote Monitor - Dell Hardware Monitoring](<../cwa/monitors/Dell Hardware Monitoring.md>)   | Remote Monitor   | Detects the event logs generated by the Dell OMSA for the Dell Servers.                                    |
