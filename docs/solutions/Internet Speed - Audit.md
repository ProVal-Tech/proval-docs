...
|--------------------------------------------------------------------------------------------------|---------------|--------------------------------------------------------------------------------------------------------------------|
| [Script - Internet Speed - Audit](<../cwa/scripts/Internet Speed - Audit.md>)                | Script        | This is the Automate implementation script that stores/modifies the data from the agnostic script into the custom table. |
...
| [Dataview - Internet Speed - Audit](<../cwa/dataviews/Internet Speed - Audit.md>)             | Dataview      | This dataview populates the complete information of the speed test                                                |
...
| [Internal Monitor - Execute Script - Internet Speed Test](<../cwa/monitors/Execute Script - Internet Speed Test.md>) | Monitor       | This internal monitor detects the Windows agent where the script [EPM - Network - Script - Internet Speed - Audit](<../cwa/scripts/Internet Speed - Audit.md>) was not run for the last 10 days. |
...
2. Import one or both dataviews: [Internet Speed - Audit](<../cwa/dataviews/Internet Speed - Audit.md>) / [Internet Latest Speed - Audit](<../cwa/dataviews/Internet Latest Speed - Audit.md>).  
...
5. Import the script [Internet Speed - Audit](<../cwa/scripts/Internet Speed - Audit.md>) and run it once on any machine with the environment variable set to 1.  
