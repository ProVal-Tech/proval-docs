...
tags: ['administration', 'windows', 'monitoring', 'management', 'security']
draft: false
unlisted: false
---
## Purpose

This document outlines the multiple solutions that can be used to manage local and domain admins.
