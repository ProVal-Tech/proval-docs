...
| [Dynamic Group - Automatic Reboot Pending Check](/docs/1c798d37-8ff8-4e73-ba39-027e025a3551) | Dynamic Group | This group is designed to schedule the [Task - Reboot Pending Check Automation](/docs/509ed97f-105b-47d7-8a66-f7da58da8138), to set the auto reboot pending automation by checking the custom field `Auto_RebootPendingCheck`.                                                                         |
