...
## Usage
1. If no Driveletters are provided, get all drive letters.
2. Determine the scope
    ...
    3. Repair - Full - Runs the Repair-Volume on that drive with the -OfflineScanAndFix switch.
...
```
Returns the state of the all internal drive's Health and adds any corruptions to the $Corrupt system file.
