...
tags: ['active-directory', 'configuration', 'setup', 'windows']
draft: false
unlisted: false
---
## Description
This script will Create a ConnectWise Automate Agent Deployment group policy object that will create a startup script (or a Scheduled Task) policy and apply that policy to the root forest in group policy management.
