---
id: '9d3b6624-5e4a-48cb-babb-f355fcd1f6d9'
slug: /9d3b6624-5e4a-48cb-babb-f355fcd1f6d9
title: 'Set Time Zone - Windows Servers'
title_meta: 'Set Time Zone - Windows Servers'
keywords: ['time', 'time-zone', 'windows']
description: 'Runs the "Manage Time Zone" automation on Windows Servers where the "cPVAL Manage Time Zone" custom field is enabled.'
...
- **Name:** `Set Time Zone - Windows Servers`  
- **Description:** `Runs the "Manage Time Zone" automation on Windows Servers where the "cPVAL Manage Time Zone" custom field is enabled.`  
...
`cPVAL Manage Time Zone` **>>** `equals` **>>** `Windows  Servers`  

![Image1](../../../static/img/docs/9d3b6624-5e4a-48cb-babb-f355fcd1f6d9/image1.webp)
...
![Image2](../../../static/img/docs/9d3b6624-5e4a-48cb-babb-f355fcd1f6d9/image2.webp)
...
![Image5](../../../static/img/docs/9d3b6624-5e4a-48cb-babb-f355fcd1f6d9/image5.webp)
