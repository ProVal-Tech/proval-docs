...
description: 'This compound condition is used to execute the script only when it needs to verify whether Remote Desktop Protocol (RDP) is enabled or disabled on the windows servers.'
...
**Description:**  `This compound condition is used to execute the script only when it needs to verify whether Remote Desktop Protocol (RDP) is enabled or disabled on the windows workstations.`
