...
title: 'Connect Secure Deployment [Windows Server]'
title_meta: 'Connect Secure Deployment [Windows Server]'
keywords: ['cybercns', 'connectsecure', 'vulnerability', 'management']
description: 'Initiates the Deploy ConnectSecure Agent [Windows] automation on Windows servers where deployment is enabled but the agent is not yet installed.'
...
Initiates the [Deploy ConnectSecure Agent [Windows]](/docs/d22e3b29-76a2-4385-a013-d592f6c5ae6d) automation on Windows servers where deployment is enabled but the agent is not yet installed.
...
[Compound Condition Configuration](https://github.com/ProVal-Tech/ninjarmm/blob/main/compound-conditions/connect-secure-deployment-windows-server.toml)
