...
title: 'Audit Installed Remote Tools - Server'
title_meta: 'Audit Installed Remote Tools - Server'
...
## Summary
Triggers the [Installed Remote Tools Audit](/docs/8111fecc-61de-4c72-933c-b719351b7a1e) automation on Windows servers where deployment is enabled.

## Details

- **Name:** `Audit Installed Remote Tools`
- **Description:** Triggers the [Installed Remote Tools Audit](/docs/8111fecc-61de-4c72-933c-b719351b7a1e) automation on Windows servers where deployment is enabled.
