---
id: '977d1dc8-2b16-4f63-a447-745c2ac21648'
slug: /977d1dc8-2b16-4f63-a447-745c2ac21648
title: 'Unknown ScreenConnect Detection - Windows Server'
title_meta: 'Unknown ScreenConnect Detection - Windows Server'
keywords: ['screenconnect', 'unwanted-screenconnect', 'unknown-screenconnect', 'unknown-screenconnect-client']
description: 'Runs the Unknown ScreenConnect Client audit and remediation script daily on Windows Servers with a ScreenConnect Client installed. Triggers an alert when non-approved instances are detected.'
...
Runs the [Manage Unknown ScreenConnect Client [Windows]](/docs/98a1813b-49c0-4b9e-8207-785884995e17) automation daily on Windows Servers where any ScreenConnect Client is installed and [cPVAL Unknown ScreenConnect Monitoring](/docs/ce85f694-4518-4e46-93e2-b008210e9627) is configured. Creates a ticket when non-approved ScreenConnect instances are detected and remain after any configured remediation.
...
**Name:** `Unknown ScreenConnect Detection - Windows Server`  
**Description:** `Runs the Unknown ScreenConnect Client audit and remediation script daily on Windows Servers with a ScreenConnect Client installed. Triggers an alert when non-approved instances are detected.`  
...
[Compound Condition Configuration](https://github.com/ProVal-Tech/ninjarmm/blob/main/compound-conditions/unknown-screenconnect-detection-windows-server.toml)
