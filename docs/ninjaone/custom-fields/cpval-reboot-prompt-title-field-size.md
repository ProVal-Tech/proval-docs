...
title_meta: 'cPVAL Reboot Prompt Title Field Size'
keywords: ['reboot', 'reboot-pending', 'uptime', 'omniprompt', 'reboot-pending-prompt']
description: 'Specifies the size of the title bar area in WIDTHxHEIGHT format.'
...
- [Custom Field Configuration](https://github.com/ProVal-Tech/ninjarmm/blob/main/custom-fields/cpval-reboot-prompt-title-field-size.toml)
