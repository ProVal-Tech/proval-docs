---
id: '92779b41-3331-480c-a72d-402c0f328af3'
slug: /92779b41-3331-480c-a72d-402c0f328af3
title: 'cPVAL Stolen System BitLocker Password'
title_meta: 'cPVAL Stolen System BitLocker Password'
keywords:  ['lock','stolen','system']
description: 'The password to use to enable BitLocker on the target machine. This custom field is used by the Lock Stolen System solution during system lockdown.'
tags: ['connectwise']
draft: false
unlisted: false
---
...
## Summary
The password to use to enable BitLocker on the target machine. This custom field is used by the `Lock Stolen System` solution during system lockdown.
