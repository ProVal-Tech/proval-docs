...
title: 'cPVAL ConnectSecure CompanyID'
title_meta: 'cPVAL ConnectSecure CompanyID'
keywords: ['cybercns', 'connectsecure', 'vulnerability', 'management']
description: 'This stores the ConnectSecure deployment Company ID.'
...
| ----- | ---- | ---------------- | ---- | -------- | ------------- | --------------------- | --------------------- | -------------- | ----------- | -------- | ----------- | ----------- |
| cPVAL ConnectSecure CompanyId | cpvalConnectsecureCompanyid | `Organization`, `Location`, `Device` | Text | True | | Editable | Read/Write | Read/Write | This stores the ConnectSecure deployment Company ID | | | ConnectSecure |
...
![Sample Run 1](../../../static/img/docs/556a0c6f-20ee-41ed-a802-b844ef54ae55/image15.webp)
