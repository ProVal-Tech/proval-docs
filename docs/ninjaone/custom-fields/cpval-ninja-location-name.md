...
description: 'Location is used during the AutoElevate agent deployment to ensure the installed agent is assigned to the correct location within the AutoElevate portal'
