---
id: 'e567d009-fc34-471c-9738-05bfed302c60'
slug: /e567d009-fc34-471c-9738-05bfed302c60
title: 'cPVAL Cisco Secure Client Windows ARP'
title_meta: 'cPVAL Cisco Secure Client Windows ARP'
keywords: ['install', 'cisco', 'secure', 'client', 'vpn']
description: 'Check this box if you want Cisco Secure Client modules to be hidden from the Add/Remove Programs section in Windows. This setting applies only to Windows systems.'
