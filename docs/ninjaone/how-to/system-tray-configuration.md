...
title: 'ProVal Tech Support'
title_meta: 'ProVal Tech Support'
keywords: ['system','tray','configure']
description: 'This document explains how to set up and use the Systray icon as part of your custom NinjaOne site.'
...
This article explains how to set up and use the Systray icon as part of your custom NinjaOne site. NinjaOne allows you to create and deploy a custom Systray icon for your organization.

## Implementation

Before you can work with the Systray icon, you must activate it in NinjaOne. To do so, navigate to Administration → General → Systray → Enable. 
...
- While clicking the `Launch` option you will see the below that needs to be filled:
     ...
     3. Windows command: Add windows command like "ipconfig /renew"
     4. Add MAC command: Add the Macos Command like "/Applications/Google\ Chrome.app"
...
- While clicking the `Seperator` option you will see the below that needs to be filled:

  1. Click seperator option
  2. Then click Apply.

![Seperator](../../../static/img/docs/b4009de0-23fa-4269-ab8d-4a230a798a72/seperator.webp)
...
- While clicking the `About` option you will see the below that needs to be filled:
     ...
     2. Label: Add the label name.
     3. Add company URL
     4. Description: Add the description that want to highlight under the user screen.
