...
| ---- | ---- | ----------- |
| Force | Checkbox | Force BitLocker to run again. If enabled, the script will decrypt the drive if it is already encrypted, then encrypt it again using the settings from the custom fields. |
