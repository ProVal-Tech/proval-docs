...
description: 'Installs and Updates the ConnectSecure v4 on Mac'
...
Installs and Updates the ConnectSecure v4 on Mac
...
[Automation Configuration](https://github.com/ProVal-Tech/ninjarmm/blob/main/scripts/install-connectsecure-mac.sh)
