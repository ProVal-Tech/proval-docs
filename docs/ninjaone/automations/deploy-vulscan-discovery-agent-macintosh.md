...
![Image1](../../../static/img/ninja-one-automation-deploy-vulscan-discovery-agent-macintosh/image1.png)

Click the `Run` button to run the script.  
**Run As:** `System`  
**Preset Parameter:** `<Leave it Blank>`  
![Image2](../../../static/img/ninja-one-automation-deploy-vulscan-discovery-agent-macintosh/image2.png)
...
**Architecture:** `64-bit`  
**Run As:** `System`  
![Image3](../../../static/img/ninja-one-automation-deploy-vulscan-discovery-agent-macintosh/image3.png)
...
![Image4](../../../static/img/ninja-one-automation-deploy-vulscan-discovery-agent-macintosh/image4.png)
...
![Image5](../../../static/img/ninja-one-automation-deploy-vulscan-discovery-agent-macintosh/image5.png)
