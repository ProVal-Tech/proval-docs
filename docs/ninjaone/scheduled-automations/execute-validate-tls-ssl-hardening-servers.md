...
- **Description:** `Triggers 'Validate TLS SSL Hardening' script on windows servers.`
...
[Scheduled Automations Configuration](https://github.com/ProVal-Tech/ninjarmm/blob/main/scheduled-automations/execute-validate-tls-ssl-hardening-servers.toml)
