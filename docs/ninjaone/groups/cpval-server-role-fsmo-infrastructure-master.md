...
description: 'A group tailored for Windows Servers that have the Infrastructure Master role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - FSMO - Infrastructure Master | A group tailored for Windows Servers that have the Infrastructure Master role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-infrastructure-master/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-infrastructure-master/image2.png)
...
**Name:** `cPVAL - Server Role - FSMO - Infrastructure Master`  
**Description:** `A group tailored for Windows Servers that have the Infrastructure Master role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-infrastructure-master/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-infrastructure-master/image4.png)
