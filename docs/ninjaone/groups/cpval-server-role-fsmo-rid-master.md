...
description: 'A group tailored for Windows Servers that have the RID Master role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - FSMO - RID Master | A group tailored for Windows Servers that have the RID Master role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-rid-master/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-rid-master/image2.png)
...
**Name:** `cPVAL - Server Role - FSMO - RID Master`  
**Description:** `A group tailored for Windows Servers that have the RID Master role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-rid-master/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-rid-master/image4.png)