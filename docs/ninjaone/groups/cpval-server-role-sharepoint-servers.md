...
description: 'A group tailored for Windows Servers that have the SharePoint Server role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - SharePoint Servers | A group tailored for Windows Servers that have the SharePoint Server role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-sharepoint-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-sharepoint-servers/image2.png)
...
**Name:** `cPVAL - Server Role - SharePoint Servers`  
**Description:** `A group tailored for Windows Servers that have the SharePoint Server role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-sharepoint-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-sharepoint-servers/image4.png)
