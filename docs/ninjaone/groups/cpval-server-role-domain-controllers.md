...
description: 'A group tailored for Windows Servers that have the Active Directory Domain Services role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Domain Controllers | A group tailored for Windows Servers that have the Active Directory Domain Services role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-domain-controllers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-domain-controllers/image2.png)
...
**Name:** `cPVAL - Server Role - Domain Controllers`  
**Description:** `A group tailored for Windows Servers that have the Active Directory Domain Services role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-domain-controllers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-domain-controllers/image4.png)