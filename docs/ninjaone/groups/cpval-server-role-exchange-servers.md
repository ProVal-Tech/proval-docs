...
description: 'A group tailored for Windows Servers that have the Exchange Server role installed'
tags: ['windows', 'dynamic-groups', 'exchange']
draft: false
unlisted: false
---
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Exchange Servers | A group tailored for Windows Servers that have the Exchange Server role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-exchange-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-exchange-servers/image2.png)
...
**Name:** `cPVAL - Server Role - Exchange Servers`  
**Description:** `A group tailored for Windows Servers that have the Exchange Server role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-exchange-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-exchange-servers/image4.png)
