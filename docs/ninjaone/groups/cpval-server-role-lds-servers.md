...
description: 'A group tailored for Windows Servers that have the Active Directory Lightweight Directory Services role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - LDS Servers | A group tailored for Windows Servers that have the Active Directory Lightweight Directory Services role installed |
...
**Condition:** `Contains`  
**Text:** `Active Directory Lightweight Directory Services`  

![Image1](../../../static/img/ninja-one-groups-cpval-server-role-lds-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-lds-servers/image2.png)
...
**Name:** `cPVAL - Server Role - LDS Servers`  
**Description:** `A group tailored for Windows Servers that have the Active Directory Lightweight Directory Services role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-lds-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-lds-servers/image4.png)