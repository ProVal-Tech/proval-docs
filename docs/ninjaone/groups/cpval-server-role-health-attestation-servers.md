...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-health-attestation-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-health-attestation-servers/image2.png)
...
![Image3](../../../static/img/ninja-one-groups-cpval-server-role-health-attestation-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-health-attestation-servers/image4.png)