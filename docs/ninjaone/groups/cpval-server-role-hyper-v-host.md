...
description: 'A group tailored for Windows Servers that have the Hyper-V role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Hyper-V Host | A group tailored for Windows Servers that have the Hyper-V role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-hyper-v-host/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-hyper-v-host/image2.png)
...
**Name:** `cPVAL - Server Role - Hyper-V Host`  
**Description:** `A group tailored for Windows Servers that have the Hyper-V role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-hyper-v-host/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-hyper-v-host/image4.png)