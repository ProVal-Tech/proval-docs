...
description: 'A group tailored for Windows Servers that have the PDC Emulator role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - FSMO - PDC Emulator | A group tailored for Windows Servers that have the PDC Emulator role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-pdc-emulator/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-pdc-emulator/image2.png)
...
**Name:** `cPVAL - Server Role - FSMO - PDC Emulator`  
**Description:** `A group tailored for Windows Servers that have the PDC Emulator role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-pdc-emulator/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-fsmo-pdc-emulator/image4.png)