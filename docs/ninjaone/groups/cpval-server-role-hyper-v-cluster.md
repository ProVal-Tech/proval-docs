---
id: '83840fa9-72f2-4bd3-9f9f-353d606d9d3c'
slug: /83840fa9-72f2-4bd3-9f9f-353d606d9d3c
title: 'cPVAL - Server Role - Hyper-V Cluster'
title_meta: 'cPVAL - Server Role - Hyper-V Cluster'
keywords: ['windows', 'servers', 'role', 'host', 'hyper-v']
description: 'A group tailored for Windows Servers that have the Hyper-V Cluster role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Hyper-V Cluster | A group tailored for Windows Servers that have the Hyper-V Cluster role installed |
...
**Condition:** `Contains`  
**Text:** `Hyper-V Cluster`  

![Image1](../../../static/img/docs/83840fa9-72f2-4bd3-9f9f-353d606d9d3c/image1.webp)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/docs/83840fa9-72f2-4bd3-9f9f-353d606d9d3c/image2.webp)
...
**Name:** `cPVAL - Server Role - Hyper-V Cluster`  
**Description:** `A group tailored for Windows Servers that have the Hyper-V Cluster role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/docs/83840fa9-72f2-4bd3-9f9f-353d606d9d3c/image3.webp)
