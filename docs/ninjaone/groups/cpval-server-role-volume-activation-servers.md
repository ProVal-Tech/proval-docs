...
description: 'A group tailored for Windows Servers that have the Volume Activation Services role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Volume Activation Servers | A group tailored for Windows Servers that have the Volume Activation Services role installed |
...
**Condition:** `Contains`  
**Text:** `Volume Activation Services`  

![Image1](../../../static/img/ninja-one-groups-cpval-server-role-volume-activation-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-volume-activation-servers/image2.png)
...
**Name:** `cPVAL - Server Role - Volume Activation Servers`  
**Description:** `A group tailored for Windows Servers that have the Volume Activation Services role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-volume-activation-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-volume-activation-servers/image4.png)