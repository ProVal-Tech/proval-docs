---
id: 'd57f8cfb-bb1e-4e9a-bf22-9bb24a35817f'
slug: /d57f8cfb-bb1e-4e9a-bf22-9bb24a35817f
title: 'cPVAL - Server Role - SMB1 Servers'
title_meta: 'cPVAL - Server Role - SMB1 Servers'
keywords: ['windows', 'servers', 'role','smb1-server', 'smb1-server']
...
A group tailored for Windows Servers that have the `SMB1 Server` role installed
...
![Image2](../../../static/img/docs/d57f8cfb-bb1e-4e9a-bf22-9bb24a35817f/image2.webp)
