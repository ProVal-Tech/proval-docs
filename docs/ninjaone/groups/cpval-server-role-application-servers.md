...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Application Servers | A group tailored for Windows Servers that have the Application Server role installed |
...
![Image1](../../../static/img/ninja-one-groups-cpval-server-role-application-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-application-servers/image2.png)
...
![Image3](../../../static/img/ninja-one-groups-cpval-server-role-application-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-application-servers/image4.png)