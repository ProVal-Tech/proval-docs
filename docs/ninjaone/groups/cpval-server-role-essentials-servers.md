...
description: 'A group tailored for Windows Servers that have the Windows Server Essentials Experience role installed'
...
| Name       | Description |
| ---------- | ----------- |
| cPVAL - Server Role - Essentials Servers | A group tailored for Windows Servers that have the Windows Server Essentials Experience role installed |
...
**Condition:** `Contains`  
**Text:** `Windows Server Essentials Experience`  

![Image1](../../../static/img/ninja-one-groups-cpval-server-role-essentials-servers/image1.png)

### Step 6

Click the `Apply` button to proceed.  
![Image2](../../../static/img/ninja-one-groups-cpval-server-role-essentials-servers/image2.png)
...
**Name:** `cPVAL - Server Role - Essentials Servers`  
**Description:** `A group tailored for Windows Servers that have the Windows Server Essentials Experience role installed`  
**Permission Type:** `Self (Private) - default`

![Image3](../../../static/img/ninja-one-groups-cpval-server-role-essentials-servers/image3.png)

## Completed Group

![Image4](../../../static/img/ninja-one-groups-cpval-server-role-essentials-servers/image4.png)