...
title_meta: 'EDSM_4096PlusThreshold_Wks'
keywords: ['monitoring', 'drive', 'space', 'thresholds', 'tickets']
description: 'Defines Site-level limit for 4096+ GB drives on Workstations. Overrides Company level, but overridden by Endpoint.'
...
Defines Site-level limit for 4096+ GB drives on Workstations. Overrides Company level, but overridden by Endpoint.
...
![Image1](../../../static/img/docs/68c691d5-4c53-4bf0-862f-415f4a1ff73a/image1.webp)
