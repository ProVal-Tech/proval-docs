...
title_meta: 'EDSM_Enable_Svr'
keywords: ['monitoring', 'drive', 'space', 'thresholds', 'tickets']
description: 'Enables or disables drive space monitoring for servers at the Company level. Overridden by Site or Endpoint settings.'
...
![Image1](../../../static/img/docs/0f5b9f59-98da-4cdd-bd21-8fa67ba81c76/image1.webp)
