---
id: 'fb66191c-89d5-4712-a4a3-e1c90f943b7b'
slug: /fb66191c-89d5-4712-a4a3-e1c90f943b7b
...
description: 'Flag this custom field to exclude the site from the BitLocker Status Audit solution.'
...
| ---- | ----- | ---- | ------- | ------------- | -------- | ----------- |
| Disable BitLocker Status Audit | SITE | Flag | | | Yes | Flag this custom field to exclude the site from the BitLocker Status Audit solution. This custom field manages the auto-execution of the task. |
