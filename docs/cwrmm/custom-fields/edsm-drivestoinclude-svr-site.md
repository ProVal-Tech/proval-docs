...
title_meta: 'EDSM_DrivesToInclude_Svr'
keywords: ['monitoring', 'drive', 'space', 'thresholds', 'tickets']
description: 'Specifies Site-level server drive letters to monitor. Overrides Company level, but overridden by Endpoint.'
...
Specifies Site-level server drive letters to monitor. Overrides Company level, but overridden by Endpoint.
...
![Image1](../../../static/img/docs/e9905b04-6467-4e18-b7c9-ada16770b3f2/image1.webp)
