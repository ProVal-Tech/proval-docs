...
title_meta: 'EDSM_Enable_Wks_Site'
keywords: ['monitoring', 'drive', 'space', 'thresholds', 'tickets']
description: 'Enables or disables drive space monitoring for workstations at the Site level. Overrides Company settings, but overridden by Endpoint.'
...
Enables or disables drive space monitoring for workstations at the Site level. Overrides Company settings, but overridden by Endpoint.
...
![Image1](../../../static/img/docs/8b27ab38-a281-4d4a-9108-e0fbfb076266/image1.webp)
