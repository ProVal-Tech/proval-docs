...
- Click on **Alert Management** -> **Monitors** -> **Create Monitor**  
  ![Image 1](../../../static/img/docs/62efcaa3-e03b-4500-a48a-f472a82f039f/image_1.png)  
  ![Image 2](../../../static/img/docs/62efcaa3-e03b-4500-a48a-f472a82f039f/image_2.png)  
...
- **Name**: Browser Saved Password Failure Detection  
  ...
  **Family**: RMM Agent  
  ![Image 3](../../../static/img/docs/62efcaa3-e03b-4500-a48a-f472a82f039f/image_3.png)  

- Set the Conditions as shown below:  
  ![Image 4](../../../static/img/docs/62efcaa3-e03b-4500-a48a-f472a82f039f/image_4.png)  
...
- Set a Target to the companies for which you would like to monitor the failure.  
  **Note**: The monitor does not allow the application of the target to a custom group.  
  ![Image 5](../../../static/img/docs/62efcaa3-e03b-4500-a48a-f472a82f039f/image_5.png)  
