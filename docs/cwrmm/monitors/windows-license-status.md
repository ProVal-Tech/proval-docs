...
1. Go to `Alert Management` > `Monitors` > `Add monitor`  
   ![Step 1](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_2_1.png)

2. Click the `Create Monitor` button.  
   ![Step 2](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_3.png)

3. This screen will appear.  
   ![Step 3](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_4.png)
...
4. **Name:** Windows License Status  
   ...
   **Severity:** Desktop Operating System  
   ![Step 4](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_5.png)

5. The `Conditions` tab will start looking like this:  
   ![Step 5](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_6.png)

6. Set the `Repeat every` to 24 Hours:  
   ![Step 6](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_7.png)

7. Disable the `Ticket Resolution` section by clicking the `Automatically resolve` button.  
   ![Step 7](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_8.png)

8. The `Conditions` section will change to this:  
   ![Step 8](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_9.png)
...
9. Paste this PowerShell script in the `Script` box.  
   ...
   ```
   ![Step 9](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_10.png)

10. Change the comparator to `OR` from `AND`  
    ![Step 10a](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_11.png)  
    ![Step 10b](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_12.png)

11. Set `Unlicensed` and `NonGenuineGrace` to the `Script Output` box.  
    ![Step 11](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_13.png)

12. Enable the `Escalate ticket on script failure`.  
    ![Step 12](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_14.png)

13. Select the required client to target from the `Select Targets` button.  
    ![Step 13a](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_15.png)  
    ![Step 13b](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_16.png)

14. Final look:  
    ![Step 14](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_17.png)

15. Click the `Save` button to save the monitor set.  
    ![Step 15](../../../static/img/docs/7c6678ef-12c5-4e21-a2d2-9fd84a21191e/image_18.png)
