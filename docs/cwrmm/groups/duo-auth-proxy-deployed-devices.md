...
1. Navigate to `Devices` > `Device Groups`.  
   ![Image](../../../static/img/docs/a940aac1-4586-4e35-90f6-749ec3b2e1d7/image_1.png)

2. Create a new dynamic group by clicking the `Dynamic Group` button.  
   ![Image](../../../static/img/docs/a940aac1-4586-4e35-90f6-749ec3b2e1d7/image_2.png)  
   This page will appear after clicking on the `Dynamic Group` button:  
   ![Image](../../../static/img/docs/a940aac1-4586-4e35-90f6-749ec3b2e1d7/image_3.png)
...
3. Set the group name to `DUO Auth Proxy Deployed Devices`.  
   ...
   ![Image](../../../static/img/docs/a940aac1-4586-4e35-90f6-749ec3b2e1d7/image_4.png)

4. Search and select the `Duo Auth Proxy Result` custom field from the search box.  
   Set `Success` in the comparison condition.  
   ![Image](../../../static/img/docs/a940aac1-4586-4e35-90f6-749ec3b2e1d7/image_5.png)  
