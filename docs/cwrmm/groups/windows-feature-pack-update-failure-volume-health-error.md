...
![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_1.png)
...
- Select `\\<font>OS Build Number\\</font>` for the Criteria, choose `Does Not Contain any` for the comparator, and type `19045` and `22631` in the condition box.  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_2.png)  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_3.png)  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_4.png)  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_5.png)

- Click the `Add Criteria` button to add another criterion.  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_6.png)
...
- Select the `Feature Update Install Failure` custom field for criteria, choose `Equal` for the comparator, and type `Volume Health Error` in the condition box.  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_7.png)  
  ![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_8.png)

## Group

Click the `Save` button to save the group.  
![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_9.png)  
![Image](../../../static/img/docs/891dd514-bfc7-4dba-b09c-7597145bb3e2/image_10.png)
