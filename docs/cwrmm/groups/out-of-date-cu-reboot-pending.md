...
1. Navigate to `Devices` > `Device Groups`.
   ![Step 1](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_1.png)

2. Create a new dynamic group by clicking the `Dynamic Group` button.  
   ![Step 2](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_2.png)  
   This page will appear after clicking on the `Dynamic Group` button:  
   ![Step 2 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_3.png)
...
3. Set the group name to `Out of Date CU - Reboot Pending`.  
   ...
   ![Step 3](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_4.png)

4. Click the `+ Add Criteria` in the `Criteria` section of the group.  
   ![Step 4](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_5.png)  
   This search box will appear.  
   ![Step 4 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_6.png)

5. Search and select the `Out_of_Date_CU_Autofix_Result` custom field from the search box.  
   ![Step 5](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_7.png)  
   Type `Reboot Pending` in the comparison condition and press `Enter`.  
   ![Step 5 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_8.png)  
   **Condition:** `Out_of_Date_CU_Autofix_Result` `Contains any of` `Reboot Pending`

6. Click the `+ Add Criteria` button.  
   ![Step 6](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_9.png)  
   A new search box will appear.  
   ![Step 6 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_10.png)  
   Search and select the `OS` criteria.  
   ![Step 6 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_11.png)  
   Select all available instances of `Microsoft Windows` `10`, `11`, `Server 2016`, `2019`, and `2022` in the comparison field.  
   ![Step 6 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_12.png)  
   ![Step 6 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_13.png)  
...
7. Click the `+ Add Criteria` button.  
   ![Step 7](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_14.png)  
   A new search box will appear.  
   ![Step 7 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_15.png)  
   Search and select the `Out_of_Date_CU_Autofix_Date` custom field from the search box.  
   ![Step 7 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_16.png)  
   Change the comparator to `Does Not Contain any of`.  
   ![Step 7 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_17.png)  
   Type `0001-01-01 00:00:00` in the comparison field and press `Enter`.  
   ![Step 7 Continued](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_18.png)  
...
8. Click the `Save` button to save/create the group.  
   ![Step 8](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_19.png)

## Completed Group

![Completed Group 1](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_20.png)  
![Completed Group 2](../../../static/img/docs/87d623c4-d8e2-4c25-b838-f9c0dee5043d/image_21.png)
