...
1. Navigate to `Devices` > `Device Groups`.  
   ![Step 1](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_1.png)

2. Create a new dynamic group by clicking the `Dynamic Group` button.  
   ![Step 2](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_2.png)  
   This page will appear after clicking on the `Dynamic Group` button:  
   ![Step 2 Continued](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_3.png)

3. Set the group name to `Disable FastBoot`.  
   ![Step 3](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_4.png)

4. Click the `+ Add Criteria` in the `Criteria` section of the group.  
   ![Step 4](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_5.png)  
   This search box will appear.  
   ![Step 4 Continued](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_6.png)

5. 
   - Search and select the `Disable_FastBoot` custom field from the search box.
   - Set `True` in the comparison condition.  
   ![Step 5](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_7.png)  
...
6. 
   ...
   ![Step 6](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_8.png)  
...
7. 
   ...
   - Set `False` in the comparison condition.  
   ![Step 7](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_8.png)  
   **Condition:** `Disable_FastBoot_Exclusion` `Equal` `False`

8. 
   - Search and select the Endpoint-Level `FastBoot_Disabled` custom field from the search box.
   - Set `False` in the comparison condition.  
   ![Step 8](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_9.png)  
...
9. 
   ...
   ![Step 9](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_10.png)  
   **Condition:** `OS` `Contains any of` `Microsoft Windows 10, Microsoft Windows 11`

10. Click the `Save` button to save/create the group.  
    ![Step 10](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_11.png)

## Completed Group

![Completed Group 1](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_12.png)  
![Completed Group 2](../../../static/img/docs/df5b7a85-683f-4fd6-9a24-4fc836ccfd8a/image_13.png)
