...
1. Navigate to `Devices` > `Device Groups`.
   ![Step 1](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_1.png)

2. Create a new dynamic group by clicking the `Dynamic Group` button.
   ![Step 2](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_2.png)  
   This page will appear after clicking on the `Dynamic Group` button:  
   ![Step 2 - Continued](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_3.png)
...
3. Set the group name to `DUO Auth for Windows Login Deployment`.  
   ...
   ![Step 3](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_4.png)

4. Click `+ Add Criteria` in the `Criteria` section of the group.  
   ![Step 4](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_5.png)  
   This search box will appear.  
   ![Step 4 - Continued](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_6.png)
...
5. - Search and select the `OS` from the search box.
   ...
   ![Step 5](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_7.png)  
...
6. - Search and select the `Duo Deployment` custom field from the search box.
   ...
   ![Step 6](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_8.png)  
...
7. - Search and select the `Duo Deployment Exclude` custom field from the search box.
   ...
   ![Step 7](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_9.png)  
...
8. - Search and select the `Duo Deployment Result` custom field from the search box.
   ...
   ![Step 8](../../../static/img/docs/c598c18f-25a9-43fd-a7b6-86e8f186c38b/image_10.png)  
