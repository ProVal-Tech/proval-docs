...
## Sample Run
![Sample Run 1](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image.png)

![Sample Run 2](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-1.png)
...
![Detail](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-27.png)
...
![MacOs](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-2.png)
...
![Set Pre-defined 1](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-3.png)

After clicking on Save the Pre-defined will show data as:

![Deployment](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-28.png)
...
![Set Pre-defined 2](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-5.png)

After clicking on Save the Pre-defined will show data as:

![Deployment ExL](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-30.png)
...
![Set Pre-defined 3](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-7.png)

After clicking on Save the Pre-defined will show data as:

![Deployment ExC](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-29.png)
...
![Set Pre-defined 4](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-8.png)

After clicking on Save the Pre-defined will show data as:

![Org ID](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-31.png)
...
![Set Pre-defined 5](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-9.png)

After clicking on Save the Pre-defined will show data as:

![Loc ID](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-32.png)
...
![If/Else/Then](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-11.png)
...
![Row 6A](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-33.png)
...
![Bash](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-34.png)

The following function will pop up on the screen:

![Bash Script 2](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-13.png)
...
![Bash Script](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-35.png)

Limit the bash file to run on `Mac` machines only.

![Limit](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-36.png)

#### Row 6c Logic: If/Then

![Logic If/Then](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-14.png)

![Logic Selected](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-15.png)
...
![Condition](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-37.png)

#### Row 6c(ii) Function: Set Custom Field

Add a new row by clicking the `Add Row` button.

![Add Row 1](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-17.png)

Search and select the `Set Custom Field` function.

![Select Custom Field](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-16.png)
...
![Set Custom field 2](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-18.png)

![Custom field 3](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-38.png)

#### Row 6c(iii) Function: Script Exit

Add a new row in the `IF` part by clicking on the Add row button.  

![Add Row 3](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-39.png)

In the script exit message, simply type `The Ninja Deployment failed on the Mac Agent. Refer to the logs: %output%`  

![Script Exit Message](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-40.png)

#### Row 6d Function: Script Log

Add a new row by clicking the `Add Row` button.

![Add Row 5](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-20.png)

Search and select the `Script Log` function.

![Script Log](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-41.png)

The following function will pop up on the screen:

![Script Log Empty](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-22.png)

In the script log message, simply type `%Output%` and click the `Save` button.

![Script Log Message](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-23.png)

#### Row 6e Function: Set Custom Field

Add a new row by clicking the `Add Row` button after `END IF`.

![Add Row 7](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-24.png)
...
![Set custom field value](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-25.png)

![Success](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-42.png)
#### Row 6f Function: Script Exit

Add a new row by clicking on the Add row button.  

![6f Image](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-43.png)

In the script exit message, leave blank

![Exit Message](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-44.png)
...
![Site ID](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-45.png)
...
![Bash Script](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-46.png)
...
![Bash cmd](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-47.png)

Limit the bash file to run on `Mac` machines only.

![LimitMac](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-48.png)
...
![Condition](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-49.png)
...
![Failed Value](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-50.png)

#### Row 6h(iii) Function: Script Exit

Add a new row by clicking on the Add row button.  

![Add Row 5](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-51.png)

In the script exit message, simply type `The Ninja Deployment failed on the Mac Agent. Refer to the logs: %output%`  

![Exit Msg](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-52.png)
...
![Script Log Function](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-53.png)
...
![Success CF](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-54.png)

#### Row 6k Function: Script Exit

Add a new row by clicking on the Add row button.  

![Script Exit](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-55.png)

In the script exit message, leave blank

![Blank](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-56.png)

#### Row 7 Function: Script Exit

Add a new row by clicking on the `Add row` after `END IF` button.  

![Row 8](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-57.png)
...
![Script Exit Msg](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-58.png)
...
![Complete Task 1](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-59.png)
![Complete Task 2](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-63.png)
![Complete Task 3](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-61.png)
...
![Schedule Task](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-26.png)
...
![Repeat](../../../static/img/docs/2893ba48-9686-424e-ba32-0c799c38f9fd/image-62.png)
