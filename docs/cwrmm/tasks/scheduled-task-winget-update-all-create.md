...
![Sample Run 1](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_1.png)

![Sample Run 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_2.png)
...
![Task Creation 1](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_3.png)

![Task Creation 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_4.png)
...
![Task Creation 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_5.png)

## Task

Start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.

![Add Row](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_6.png)

This function will appear.

![Function Appears](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_7.png)

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.

![PowerShell Script Selection](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_8.png)

![PowerShell Script Selected](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_9.png)
...
![PowerShell Script Pasted](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_10.png)

### Row 2 Logic: If Then

![Row 2 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_11.png)

![Row 2 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_12.png)

### Row 2a Condition: Output Contains

Type `Unsupported` in the `Input Value or Variable` field and press `Enter`.

![Row 2a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_13.png)

### Row 2b Function: Script Log

Add a new row by clicking on the `Add Row` button.

![Add Row for Script Log](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_14.png)

Search and select the `Script Log` function.

![Script Log Selection](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_15.png)

![Script Log Selected](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_16.png)
...
![Add Row for Script Exit](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_14.png)

Search and select the `Script Exit` function.

![Script Exit Selection](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_17.png)

**Note:** Do not add any message or words in the `Error Message` field. Leave it blank and click the `Save` button.

### Row 3 Logic: If Then

![Row 3 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_11.png)

![Row 3 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_12.png)

### Row 3a Condition: Custom Field Equals

Select the `Custom Field` option from the dropdown.

![Row 3a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_18.png)

![Row 3a Condition 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_19.png)

Search and select the `WingetUpdateAll_Task_Result` custom field in the `Search` field.

![Row 3a Condition 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_20.png)

![Row 3a Condition 4](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_21.png)

Change the operator to `Equals` from `Contains`.

![Row 3a Condition 5](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_22.png)

Type `Task Created` in the comparator field and press `Enter`.

![Row 3a Condition 6](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_23.png)
...
![Row 4 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_11.png)

![Row 4 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_12.png)

### Row 4a Condition: Custom Field Equals

Select the `Custom Field` option from the dropdown.

![Row 4a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_18.png)

![Row 4a Condition 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_19.png)

Search and select the `WingetUpdateAll_Task_Create` custom field in the `Search` field.

![Row 4a Condition 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_24.png)

![Row 4a Condition 4](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_25.png)

Change the operator to `Equals` from `Contains`.

![Row 4a Condition 5](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_26.png)

Keep the comparator to `False`.

![Row 4a Condition 6](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_27.png)
...
![Row 5 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_11.png)

![Row 5 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_12.png)

### Row 5a Condition: Custom Field Equals

Select the `Custom Field` option from the dropdown.

![Row 5a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_18.png)

![Row 5a Condition 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_19.png)

Search and select the `wingetupdateall_task_Exclude` custom field in the `Search` field.

![Row 5a Condition 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_28.png)

Change the operator to `Equals` from `Contains`.

![Row 5a Condition 4](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_29.png)

Change the comparator to `True` from `False`.

![Row 5a Condition 5](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_30.png)
...
![Row 6 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_11.png)

![Row 6 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_12.png)

### Row 6a Condition: Custom Field Equals

Select the `Custom Field` option from the dropdown.

![Row 6a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_18.png)

![Row 6a Condition 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_19.png)
...
![Row 6a Condition 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_31.png)

Change the comparator to `True` from `False`.

![Row 6a Condition 4](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_30.png)
...
![Row 7 Logic](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_32.png)

![Row 7 Logic 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_33.png)

### Row 7a Condition: Custom Field Equals

Select the `Custom Field` option from the dropdown.

![Row 7a Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_18.png)

![Row 7a Condition 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_19.png)
...
![Row 7a Condition 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_34.png)

Change the operator to `Equals` from `Contains`.

![Row 7a Condition 4](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_35.png)

Change the comparator to `True` from `False`.

![Row 7a Condition 5](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_36.png)

Add another condition by clicking the `Add Condition` button.

![Add Condition](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_37.png)

Change the logical operator to `Or` from `And`.

![Change Logical Operator](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_38.png)

Select the `Custom Field` option from the dropdown.

![Row 7a Condition 6](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_39.png)
...
![Completed Script 1](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_40.png)

![Completed Script 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_41.png)

![Completed Script 3](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_42.png)

Click the `Save` button at the top right corner of the screen to save the script.

![Save Script](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_43.png)
...
![Schedule Task](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_44.png)

This screen will appear.

![Schedule Confirmation](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_45.png)

Click the `Does not repeat` button.

![Change Schedule](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_46.png)

This pop-up box will appear.

Click the `OK` button to save the schedule. Recurrence will be changed to `Every day`.

![Save Schedule](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_47.png)

Select the `Device Groups` option in the `Targeted Resources` section.

![Select Device Groups](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_48.png)

Search and select the [Winget Update All (Task Create)](/docs/22ee8d54-e19d-4b47-9ccd-c45c259f8fb7) device group.

![Select Device Group](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_49.png)

Now click the `Run button` to initiate the task.

![Run Task](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_50.png)

The task will start appearing in the Scheduled Tasks.

![Scheduled Tasks](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_51.png)

![Scheduled Tasks 2](../../../static/img/docs/a898b5ac-23d0-4e0d-89e5-79bca2277a6e/image_52.png)
