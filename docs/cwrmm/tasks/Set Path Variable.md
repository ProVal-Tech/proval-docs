...
tags: ['configuration', 'windows', 'setup', 'script', 'custom']
draft: false
unlisted: false
---
## Summary
...
|------|---------|----------|------|-------------|
| Path | - 'C:\\Temp' <br> - 'C:\\Temp', 'C:\\Temp\\ProgramData', 'D:\\Text Files' | True | Text String | Comma Separated list of the path(s) to add to the path variable.<br>**Requirement:** <ul><li>Each path should be enclosed between single quotes.</li><li>Path should exist on the end machine.</li></ul> |
