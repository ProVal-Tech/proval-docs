...
![Sample Run Image 1](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_1.png)

Provide the user parameter value as per the requirement and then click 'Continue to scheduling'.

![Sample Run Image 2](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_2.png)

Click 'Run task' to schedule the task immediately.

![Sample Run Image 3](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_3.png)
...
![Create Task Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_4.png)
...
![Create Task Image 2](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_5.png)

### Script

Start by making three separate rows. You can do this by clicking the "Add Row" button at the bottom of the script page.

![Script Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_6.png)

### Row 1: Function: Script Log

![Row 1 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_7.png)

Paste the highlighted text: `Checking OS`

![Row 1 Image 2](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_8.png)

### Row 2: Function: PowerShell Script

![Row 2 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_9.png)
...
![Row 4 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)

### Row 4a: Condition: Output Contains

In the IF part, enter `Workstation` in the right box of the "Output Does Not Contain" part.

![Row 4a Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_11.png)
...
![Row 4b Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_12.png)
...
![Row 5 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)

### Row 5a: Condition: Custom Field Equals

In the IF part, enter `true` in the right box of the "Custom Field Equals" part.

![Row 5a Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_13.png)
...
![Row 5b Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_14.png)
...
![Row 5e Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)
...
![Row 5e.1 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_15.png)
...
![Row 5e.2 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_16.png)

### Row 5f: Function: Script Log

In the script log message, type `Reboot successfully scheduled on %output%.`

![Row 5f Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_17.png)
...
![Row 6 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_18.png)
...
![Row 7 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_19.png)
...
![Row 8 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_20.png)

### Row 9: Logic: If/Then

![Row 9 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)

### Row 9a: Condition: Custom Field Equals

In the IF part, enter `true` in the right box of the "Custom Field Equals" part.

![Row 9a Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_21.png)
...
![Row 9b Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_22.png)
...
![Row 10 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_23.png)
...
![Row 13 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)
...
![Row 13a Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_24.png)
...
![Row 13b Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_25.png)
...
![Row 13e Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_10.png)

### Row 13e.1: Condition: Output Contains

In the IF part, enter `RebootDateTime` in the right box of the "Output Contains" part.

![Row 13e.1 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_26.png)

### Row 13e.2: Function: Script Log

In the script log message, type `Reboot successfully scheduled on %output%.`

![Row 13e.2 Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_17.png)
...
![Row 13f Image](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_27.png)

### Row 14: Complete

The complete script looks as shown below:

![Complete Script Image 1](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_28.png)

![Complete Script Image 2](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_29.png)

![Complete Script Image 3](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_30.png)

![Complete Script Image 4](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_31.png)
...
![Deployment Step 1](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_32.png)

This screen will appear.

![Deployment Step 2](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_33.png)

- Select the relevant time to run the script and click the 'Do not repeat' button.

![Deployment Step 3](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_34.png)

- Select the target to schedule the 'Workstation Reboot Schedule on Specific Days'.

![Deployment Step 4](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_35.png)

- Now click the `Run` button once all customization is set to initiate the task.

![Deployment Step 5](../../../static/img/docs/0957012a-a6da-4e1b-abec-936a0a467e6a/image_36.png)
