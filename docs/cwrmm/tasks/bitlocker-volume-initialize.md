...
![Sample Run 1](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_3.png)

![Sample Run 2](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_4.png)

![Sample Run 3](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_5.png)
...
![User Parameters](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_6.png)
...
![Task Creation 1](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_7.png)

![Task Creation 2](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_8.png)

**Name:** Bitlocker - Volume - Initialize  \
**Description:** `Encrypts a drive with BitLocker disk encryption.`  \
**Category:** Security  

![Task Creation 3](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_9.png)
...
![Add Parameter](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_10.png)

This screen will appear.

![Parameter Screen](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_11.png)

- Set `MountPoint` in the `Parameter Name` field.
- Select `Text String` from the `Parameter Type` dropdown menu.
- Click the `Save` button.

![MountPoint Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_12.png)
...
![AllowTPM/Reboot Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_13.png)
...
![KeyProtectorType Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_14.png)
...
![PIN/Password Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_15.png)
...
![Path/ADAccount Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_16.png)
...
![SkipHardwareTest Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_17.png)
...
![EncryptionMethod Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_18.png)

## Task
Navigate to the Script Editor Section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.

![Add Row](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_19.png)

A blank function will appear.

![Blank Function](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_20.png)

### Row 1 Function: PowerShell Script
Search and select the `PowerShell Script` function.

![PowerShell Script](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_21.png)

![PowerShell Script Selected](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_22.png)

The following function will pop up on the screen:

![PowerShell Function](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_23.png)
...
![Row 1 Function Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_24.png)

### Row 2 Function: Script Log
Add a new row by clicking the `Add Row` button.

![Add Row](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_25.png)

A blank function will appear.

![Blank Function](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_26.png)

Search and select the `Script Log` function.

![Script Log](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_27.png)

The following function will pop up on the screen:

![Script Log Function](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_28.png)

In the script log message, simply type `%output%` and click the `Save` button.

![Script Log Save](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_29.png)

Click the `Save` button at the top-right corner of the screen to save the script.

![Save Script](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_30.png)

## Completed Task

![Completed Task](../../../static/img/docs/85513764-8240-40fb-be86-7be910ea62cf/image_31.png)
