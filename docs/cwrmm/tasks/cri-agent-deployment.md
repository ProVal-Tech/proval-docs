...
![Sample Run 1](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_1.png)

![Sample Run 2](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_2.png)
...
![Task Details](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_4.png)
...
![Row 1 Image 1](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_6.png)

![Row 1 Image 2](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_7.png)
...
![Row 2 Image 1](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_8.png)

![Row 2 Image 2](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_9.png)
...
![Row 3 Image 1](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_10.png)

![Row 3 Image 2](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_11.png)
...
![Row 4 Image](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_12.png)

In the script log message, simply type `%output%` so that the script will send the results of the PowerShell script above to the output on the Automation tab for the target device.

![Log Output](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_13.png)

### Row 5: Logic: If/Then/Else

![Row 5 Image 1](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_14.png)

![Row 5 Image 2](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_15.png)

### Row 4a: Condition: Output Contains

In the IF part, enter `Installation failed` in the right box of the "Output Contains" section.

![Condition Image](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_16.png)
...
![Custom Field](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_17.png)
...
![Set Custom Field](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_18.png)

Once all items are added, please save the task. The final task should look like the screenshot below.

![Final Task Screenshot](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_19.png)
...
![Schedule Screen](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_20.png)

- Select the relevant time to run the script and click the Do not repeat button.

![Select Time](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_21.png)

- A pop-up box will appear.
- Change the number of hours to `2` and click `OK`.

![Change Hours](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_22.png)
...
![Resources Selection](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_23.png)

Now click the `Run` button to initiate the task.

![Run Task](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_24.png)
