...
![Sample Run 1](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_1.png)  

**Example 1:** Removing a local user account and profile

![Sample Run 2](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image2.png) 

**Example 2:** Removing an user profile and preserving the user

![Sample Run 3](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image3.png) 

**Example 3:** Removing the user profile of a domain user

![Sample Run 4](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image4.png) 

**Example 4:** Removing multiple unknown/cached user profiles using `SID`

![Sample Run 5](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image5.png) 

![Sample Run 6](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_3.png) 
...
![User Parameters Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_4.png)

## Task Creation

Create a new `Script Editor` style script in the system to implement this task.  
![Task Creation Image 1](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_5.png)  
![Task Creation Image 2](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_6.png)  

**Name:** `Remove User Profile`  
**Description:** `Deletes a user profile and removes the user account if local`  
**Category:** `Custom`  
![Task Creation Image 3](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_7.png)  
...
![Add Username Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_8.png)  

This screen will appear.  
![Username Parameter Screen](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_9.png)  
- Set `Username` in the `Parameter Name` field.
- Select `Text String` from the `Parameter Type` dropdown menu.
- Click the `Save` button.

![Username Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_10.png)  

### PreserveUser:

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add PreserveUser Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_8.png)  

This screen will appear.  
![PreserveUser Parameter Screen](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_9.png)  
- Set `PreserveUser` in the `Parameter Name` field.
- Select `Flag` from the `Parameter Type` dropdown menu.
- Click the `Save` button.

![PreserveUser Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_11.png)  

### SID:

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![SID Add Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_8.png)  

This screen will appear.  
![SID Parameter Screen](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_9.png)  
- Set `SID` in the `Parameter Name` field.
- Select `Text String` from the `Parameter Type` dropdown menu.
- Click the `Save` button.

![SID Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image10.png)  

### I_have_read_the_description_and_agree_to_the_user_agreement:

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![I_have_read_the_description_and_agree_to_the_user_agreement Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_8.png)  

This screen will appear.  
![I_have_read_the_description_and_agree_to_the_user_agreement Parameter Screen](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_9.png)  
- Set `I_have_read_the_description_and_agree_to_the_user_agreement` in the `Parameter Name` field.
- Enable the `Required Field` button.
- Select `Flag` from the `Parameter Type` dropdown menu.
- Click the `Save` button.

![I_have_read_the_description_and_agree_to_the_user_agreement Parameter Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/Image11.png)  

## Task

Navigate to the Script Editor section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Add Row Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_12.png)  

A blank function will appear.  
![Blank Function Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_13.png)  

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.  
![PowerShell Script Selection Image 1](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_14.png)  
![PowerShell Script Selection Image 2](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_15.png)  

The following function will pop up on the screen:  
![PowerShell Script Function Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_16.png)  
...
![PowerShell Script Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_17.png)  

### Row 2 Function: Script Log

Add a new row by clicking the `Add Row` button.  
![Add Script Log Row Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_18.png)  

A blank function will appear.  
![Blank Function Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_19.png)  

Search and select the `Script Log` function.  
![Script Log Selection Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_20.png)  

The following function will pop up on the screen:  
![Script Log Function Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_21.png)  

In the script log message, simply type `%Output%` and click the `Save` button.  
![Save Script Log Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_22.png)  

Click the `Save` button at the top-right corner of the screen to save the script.  
![Save Script Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_23.png)  

## Completed Task

![Completed Task Image](../../../static/img/docs/97ff1c2c-6782-4bd1-a169-d2aa908c89b4/image_24.png)  
