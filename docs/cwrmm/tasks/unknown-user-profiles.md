...
![Image1](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image1.png)  
![Image2](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image2.png)

## Task Creation

Create a new `Script Editor` style script in the system to implement this task.  
![Image3](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image3.png)  
![Image4](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image4.png)

**Name:** `Unknown User Profiles`  
**Description:** `This script identifies unknown user-profiles and generates a ticket containing their details. If the computer’s domain trust relationship is broken, the script will create a ticket indicating the broken trust relationship instead of listing unknown user profiles. Note that PowerShell 5 is required to run this script, and domain controllers are excluded from its scope.`  
**Category:** `Custom`  

![Image5](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image5.png)

## Task

Navigate to the Script Editor section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Image6](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/image6.png)  

A blank function will appear.  
![Image7](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/image7.png)
...
![Image8](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image8.png)  
![Image9](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image9.png)  
![Image10](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image10.png) 


### Row 2 Function: PowerShell Script

Add a new row by clicking the `Add Row` button.  
![Image11](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image11.png) 
...
![Image12](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image12.png) 
...
#endregion
```  
![Image13](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image13.png)  
![Image14](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image14.png)  

### Row 3 Logic: If/Then/Else

Add a new `If/Then/Else logic` from the `Add Logic` dropdown menu  
![Image15](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image15.png) 

A blank logic will appear  
![Image16](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image16.png) 
...
![Image17](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image17.png)  

### Row 3b Function: Script Exit

Add a new row by clicking the `Add Row` button inside the `If` section.  
![Image18](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image18.png) 

A blank function will appear.  
![Image20](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image20.png)  

Search and select the `Script Exit` function.  
The following function will pop up on the screen:  
![Image19](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image19.png)  

Type `%Output%` in the `Error Message` and click the `Save` button to save the function.  
![Image21](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image21.png)  
![Image22](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image22.png)  

### Row 3c Logic: If/Then/Else

Add a new `If/Then/Else logic` from the `Add Logic` dropdown menu inside the `Else` section.  
![Image23](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image23.png) 

A blank logic will appear  
![Image24](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image24.png) 
...
![Image25](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image25.png) 

### Row 3c(ii) Function: Create Ticket

Add a new row by clicking the `Add Row` button inside the `If` section.  
![Image26](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image26.png) 

A blank function will appear.  
![Image27](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image27.png)  

Search and select the `Create Ticket` function.  
The following function will pop up on the screen:  
![Image28](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image28.png)  
...
![Image29](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image29.png)  
![Image30](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image30.png)
...
![Image31](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image31.png) 

A blank logic will appear  
![Image32](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image32.png) 
...
![Image33](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image33.png)

### Row 3c(iv)(2) Function: Create Ticket

Add a new row by clicking the `Add Row` button inside the innermost `If` section.  
![Image35](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image35.png) 

A blank function will appear.  
![Image34](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image34.png)  
...
![Image36](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image36.png)  
![Image37](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image37.png)  
...
The following function will pop up on the screen:  
![Image38](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image38.png)  

Type `%Output%` in the `Script Log Message` and click the `Save` button to save the function.  
![Image39](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image39.png)  
![Image40](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image40.png)  

### Row 3c(iv)(4) Function: Script Log

Add a new row by clicking the `Add Row` button inside the innermost `Else` section.  
![Image41](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image41.png) 

A blank function will appear.  
![Image42](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image42.png)  
...
![Image43](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image43.png)  

## Completed Task

![Image46](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image46.png)  
...
![Image47](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image47.png)  

The following screen will appear:  
![Image48](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image48.png)  

Select the `Schedule` button and click the `calendar icon` to change the recurrence schedule.  
![Image49](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image49.png)

Select the `Weeks` for the `Repeat`, set `M` for `Day`, and click the `OK` button to save the schedule.  
![Image50](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image50.png) 

Click the `Select Targets` button to select the concerned target.  
![Image51](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image51.png)  
...
![Image52](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image52.png)  

Click the `Run` button to initiate the schedule.  
![Image53](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image53.png)  
...
![Image54](../../../static/img/docs/93f21631-9100-46fc-864b-3af17bc91699/Image54.png)  