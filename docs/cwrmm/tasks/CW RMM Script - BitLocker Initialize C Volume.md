---
id: 'rmm-bitlocker-initialize-c-volume'
...
tags: ['security', 'encryption', 'windows', 'setup']
draft: false
unlisted: false
---
## Summary
...
|--------------------|---------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Allow_TPM/Reboot   | 0             | True     | Options for allowing TPM initialization and rebooting.<br>0 = Do not allow<br>1 = Allow TPM Initialization<br>2 = Allow Reboot<br>3 = Allow TPM Initialization and Reboot                                                                                 |
