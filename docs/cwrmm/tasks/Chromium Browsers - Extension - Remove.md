...
tags: ['configuration', 'software', 'windows', 'web-browser', 'security']
draft: false
unlisted: false
---
## Summary

Remove Extensions from the Popular Chromium Browsers ('Chrome', 'Edge', 'Brave', 'Vivaldi', 'Chromium').
...
**Description:** Removes extensions from popular Chromium Browsers ('Chrome', 'Edge', 'Brave', 'Vivaldi', 'Chromium')  
