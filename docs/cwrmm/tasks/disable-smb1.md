...
![Sample Run 1](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_2.png)

![Sample Run 2](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_3.png)
...
![Create Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_4.png)

![Create Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_5.png)

**Name:** Disable SMB1  
**Description:** This script disables the SMB1 protocol on the target machine for both versions below and above '6.3'.  
**Category:** Security

![Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_6.png)

### Script

Start by making three separate rows. You can do this by clicking the "Add Row" button at the bottom of the script page.

![Add Row](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_7.png)

#### Row 1 Function: PowerShell Script

![PowerShell Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_8.png)

![PowerShell Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_9.png)
...
![PowerShell Script](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_10.png)

Save and move to the next row.

#### Row 2 Function: Script Log

![Script Log](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_11.png)
...
![Script Log](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_12.png)

#### Row 3 Logic: If/Then/Else

![If/Then/Else](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_13.png)

There will be two sections: If part and Else part.

![If/Then/Else](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_14.png)

##### Row 3a Condition: Output Contains

In the IF part, enter **Disabled** in the right box of the "Output Contains" part.

![Output Contains](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_15.png)

##### Row 3b Function: Script Exit

Add a new row by clicking on the Add Row button.

![Add Row](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_16.png)
...
![Script Exit](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_17.png)

![Script Exit](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_18.png)
...
![Script Exit](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_19.png)

Once all items are added, please save the task.  
The final task should look like the screenshot below.

![Final Task](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_20.png)
...
![Schedule Task](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_21.png)

- This screen will appear.

![Schedule Task](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_22.png)

- Select the relevant time to run the script and click the Does not repeat button.

![Schedule Task](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_23.png)

- This pop-up box will appear.
- Change the number of days to `7` and click `OK`.

![Change Days](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_24.png)

![Change Days](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_25.png)
...
![Select Groups](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_26.png)

- Now click the `Run` button to initiate the task.

![Run Task](../../../static/img/docs/70c7fa58-20bf-47b1-bbeb-aae491390406/image_27.png)
