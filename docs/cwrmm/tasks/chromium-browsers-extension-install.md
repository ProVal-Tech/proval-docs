...
![Sample Run 1](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_1.png)  
![Sample Run 2](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_2.png)  
![Sample Run 3](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_3.png)  
...
![Task Creation Image 1](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_4.png)  
![Task Creation Image 2](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_5.png)  
...
![Task Creation Image 3](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_6.png)  

## Parameters

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Parameter Image 1](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_7.png)  

This screen will appear.  
![Parameter Image 2](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_8.png)  

- Set `ExtensionID` in the `Parameter Name` field.
- Enable the `Required Field` option.
- Select `Text String` from the `Parameter Type` dropdown menu.
- Click the `Save` button.  
![Parameter Image 3](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_9.png)  
- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Parameter Image 4](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_10.png)  

Add another parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Parameter Image 5](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_7.png)  

This screen will appear.  
![Parameter Image 6](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_8.png)  

- Set `Target` in the `Parameter Name` field.
- Select `Text String` from the `Parameter Type` dropdown menu.
- Click the `Save` button.  
![Parameter Image 7](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_11.png)  
- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Parameter Image 8](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_10.png)  

## Task

Navigate to the Script Editor Section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Task Image 1](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_12.png)  

A blank function will appear.  
![Task Image 2](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_13.png)  

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.  
![Task Image 3](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_14.png)  
![Task Image 4](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_15.png)  

The following function will pop up on the screen:  
![Task Image 5](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_16.png)  
...
![Task Image 6](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_17.png)  

Click the `Save` button at the top-right corner of the screen to save the script.  
![Task Image 7](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_18.png)  

## Completed Task

![Completed Task Image](../../../static/img/docs/36fa496a-be60-416f-87a6-f725a1241540/image_19.png)  
