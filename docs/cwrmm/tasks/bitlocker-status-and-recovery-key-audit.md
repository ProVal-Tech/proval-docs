...
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_4.png)
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_5.png)
...
**Category:** Custom  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_6.png)

## Script

Start by making three separate rows. You can do this by clicking the "Add Row" button at the bottom of the script page.

![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_7.png)

**Row 1 Function:** PowerShell Script  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_8.png)
...
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_9.png)

Save and move to the next row.

**Row 2 Function:** Script Log  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_10.png)

In the script log message, simply type `%output%` so that the script will send the results of the PowerShell script above to the output on the Automation tab for the target device.  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_11.png)

**Row 3 Function:** Set Custom Field  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_12.png)

When you select "Set Custom Field," a new window will open. In this window, find the "BitLocker Status and Key" field.  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_13.png)

In the Value area, simply type `%output%` to store the PowerShell output in the custom field.  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_14.png)

Once all items are added, please save the task.  
The final task should look like the screenshot below.  
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_15.png)
...
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_16.png)
...
![Image](../../../static/img/docs/58ddde1a-dfdd-4eb8-9024-608e7c57ad4f/image_17.png)
