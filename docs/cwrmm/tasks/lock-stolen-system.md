...
**Category:** Custom  
![Category](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image4.png)
...
![Parameter1](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image17.png)
...
- Click the `Save` button.
- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Parameter2](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image18.png)

All the parameters will look like as shown below:  
![Parameters](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image19.png)
...
![Add Logic](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image5.png)

## Step 1 Logic: If/Then

Select IF/Then Logic from the Add Logic dropdown menu. 

![IF/Then](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image6.png)
...
![image7](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image7.png)
...
![image8](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image8.png)
![image9](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image9.png)
...
![image10](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image10.png)
![image11](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image11.png)

## Row 4 Function: Script Log

- Add another function `Script Log` in the IF section. 
- In the script log message, simply type `%output%` so that the script will send the results of the PowerShell script above to the output on the Automation tab for the target device.  
![Script Log](../../../static/img/docs/09fb13cb-05b1-4515-8041-128689d933ff/image_15.png)
...
![image12](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image12.png)
...
![image13](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image13.png)
...
![image14](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image14.png)
...
![image15](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image15.png)
...
![image25](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image25.png)

### Row 8 Function: CMD Script

Search and select the `Command Prompt Script` function.  
![CMD Function](../../../static/img/docs/09fb13cb-05b1-4515-8041-128689d933ff/image2.png)

The following function will pop up on the screen:  
![Function Popup](../../../static/img/docs/09fb13cb-05b1-4515-8041-128689d933ff/image3.png)
...
## Completed Task
![image16](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image16.png)
...
![image24](../../../static/img/docs/ff056937-ea5b-48f4-b76d-74566b981da8/image24.png)
