...
![Sample Run 1](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_1.png)  
![Sample Run 2](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_2.png)  
![Sample Run 3](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_3.png)  
...
![User Parameters](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_4.png)  

## Task Creation

Create a new `Script Editor` style script in the system to implement this Task.  
![Create Script](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_5.png)  
![Script Editor](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_6.png)  

**Name:** Install Microsoft VCRedist  
**Description:** Install Microsoft Visual C++ Redistributable  
**Category:** Application  

![Category](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_7.png)  

### Parameters

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add Parameter](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_8.png)  

This screen will appear.  
![Parameter Screen](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_9.png)  
...
![Save Parameter](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_10.png)  
- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Confirm Parameter](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_11.png)  
...
- Click the `Save` button.  
![Save Parameter](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_12.png)  
- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Confirm Parameter](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_11.png)  
...
![Add Row](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_13.png)  

A blank function will appear.  
![Blank Function](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_14.png)  

#### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.  
![Select PowerShell Script](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_15.png)  
![PowerShell Script](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_16.png)  

The following function will pop up on the screen:  
![PowerShell Function](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_17.png)  
...
![Script Save](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_18.png)  

Click the `Save` button at the top-right corner of the screen to save the script.  
![Save Script](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_19.png)  

## Completed Task

![Completed Task](../../../static/img/docs/f352df80-1ff9-4666-9a0e-410d6ef967c1/image_20.png)  
