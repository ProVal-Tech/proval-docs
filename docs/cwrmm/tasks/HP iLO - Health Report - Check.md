...
tags: ['custom', 'script', 'log', 'health', 'check', 'connectwise']
draft: false
unlisted: false
---
## Summary
...
|-------------|-----------------------------|----------|-------------|-------------------------------------------------------------------------------------------------|
| `Address`   | - 192.168.2.16<br>- 192.168.7.13:54 | True     | Text String | IP address of the iLO Device. Port number must be added if a custom port is being used.       |
