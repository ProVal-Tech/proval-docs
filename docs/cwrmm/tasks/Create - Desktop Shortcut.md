...
tags: ['desktop', 'management', 'setup', 'configuration', 'software']
draft: false
unlisted: false
---
## Summary
...
![Sample Run Image 3](..\..\..\static\img\Create---Desktop-Shortcut\image_3.png)
...
![User Parameters Image](..\..\..\static\img\Create---Desktop-Shortcut\image_4.png)
...
![Parameters Image 1](..\..\..\static\img\Create---Desktop-Shortcut\image_8.png)
...
![TargetUri Confirm Image](..\..\..\static\img\Create---Desktop-Shortcut\image_11.png)
...
![ShortcutName Image](..\..\..\static\img\Create---Desktop-Shortcut\image_12.png)

Click the `Confirm` button to save the parameter.

![ShortcutName Confirm Image](..\..\..\static\img\Create---Desktop-Shortcut\image_13.png)
...
![IconLocation Image](..\..\..\static\img\Create---Desktop-Shortcut\image_14.png)

Click the `Confirm` button to save the parameter.

![IconLocation Confirm Image](..\..\..\static\img\Create---Desktop-Shortcut\image_15.png)
...
![Task Blank Function Image](..\..\..\static\img\Create---Desktop-Shortcut\image_18.png)

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.

![PowerShell Script Image](..\..\..\static\img\Create---Desktop-Shortcut\image_19.png)

The following function will pop up on the screen:

![PowerShell Script Popup Image](..\..\..\static\img\Create---Desktop-Shortcut\image_20.png)
...
![PowerShell Script Editor Image](..\..\..\static\img\Create---Desktop-Shortcut\image_21.png)

### Row 2 Function: Script Log

Add a new row by clicking the `Add Row` button.

![Script Log Image](..\..\..\static\img\Create---Desktop-Shortcut\image_22.png)

A blank function will appear.

![Script Log Blank Function Image](..\..\..\static\img\Create---Desktop-Shortcut\image_18.png)

Search and select the `Script Log` function.

![Script Log Function Image](..\..\..\static\img\Create---Desktop-Shortcut\image_23.png)

The following function will pop up on the screen:

![Script Log Popup Image](..\..\..\static\img\Create---Desktop-Shortcut\image_24.png)

In the script log message, simply type `%output%` and click the `Save` button.

![Script Log Save Image](..\..\..\static\img\Create---Desktop-Shortcut\image_25.png)

Click the `Save` button at the top-right corner of the screen to save the script.

![Script Log Save Confirmation Image](..\..\..\static\img\Create---Desktop-Shortcut\image_26.png)

## Completed Task

The Script Editor should look like this:

![Completed Task Image](..\..\..\static\img\Create---Desktop-Shortcut\image_27.png)
