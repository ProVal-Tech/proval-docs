...
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_1.png)
...
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_2.png) ![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_3.png)

## Task Creation

Create a new `Script Editor` style script in the system to implement this task.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_4.png)  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_5.png)  

**Name:** Set Windows Update Registry Values  
**Description:** Set required registry values to enable Windows updates from CW RMM.  
**Category:** Patching  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_6.png)

## Task

Navigate to the Script Editor section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_7.png)  

A blank function will appear.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_8.png)  

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_9.png) ![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_10.png)  

The following function will pop up on the screen:  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_11.png)  
...
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_12.png)  

### Row 2 Function: Script Log

Add a new row by clicking the `Add Row` button.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_13.png)  

A blank function will appear.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_14.png)  

Search and select the `Script Log` function.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_15.png)  

![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_16.png)  

The following function will pop up on the screen:  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_17.png)  

In the script log message, simply type `%output%` and click the `Save` button.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_18.png)  

Click the `Save` button at the top-right corner of the screen to save the script.  
![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_19.png)  

## Completed Task

![Image](../../../static/img/docs/bd00b8d9-5f7f-449a-bf03-90a0ee610d3a/image_20.png)
