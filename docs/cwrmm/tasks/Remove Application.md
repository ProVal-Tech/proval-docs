...
|------------------|---------------------------------------------------------------------------------------------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ApplicationName  | 'Google Chrome' <br><br>'Google Chrome','Microsoft OneDrive','VMware Tools'                     | True     | The name of the application(s) to remove is encoded in the single quotation mark. When specifying multiple application names, ensure they are separated by a comma (,) without any spaces with each application encoded with a single quotation, as depicted in the example.                                                               |
