...
![Sample Run 1](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_1.png)  
![Sample Run 2](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_2.png)
...
![Task Creation Image 1](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_3.png)  
![Task Creation Image 2](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_4.png)  
...
![Task Creation Image 3](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_5.png)  

## Task

Navigate to the Script Editor Section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_6.png)  

A blank function will appear.  
![Blank Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_7.png)  

### Row 1 Function: Set Pre-defined Variable

Search and select the `Set Pre-defined Variable` function.  
![Set Pre-defined Variable](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_8.png)  
![Select Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_9.png)  

The following function will pop up on the screen:  
![Function Popup](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_10.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_11.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_12.png)  

### Row 2 Function: Set Pre-defined Variable

Add a new row by clicking on the `Add Row` button.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_13.png)  
...
- Click the `Save` button to save the changes.  
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_14.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_15.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_16.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_17.png)  
...
- Click the `Save` button to save the changes.  
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_18.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_19.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_20.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_21.png)  
...
![PowerShell Script](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_22.png)  
![Select Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_23.png)  

The following function will pop up on the screen:  
![Function Popup](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_24.png)  
...
![PowerShell Script](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_25.png)  

### Row 5 Logic: If/Then

![Logic](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_26.png)  

A blank function will appear.  
![Blank Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_27.png)  

### Row 5a Condition: Output Contains

Type `Disable` in the `Input Value or Variable` field and press `Enter`.  
![Output Contains](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_28.png)  

### Row 5b Function: Script Log

Click the `Add Row` button inside the `If/Then` logic.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_29.png)  

Search and select the `Script Log` function in the newly appeared row.  
![Script Log](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_30.png)  
![Select Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_31.png)  

The following function will pop up on the screen:  
![Function Popup](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_32.png)  

Type `Autofix is disabled.` in the `Script Log Message` field and click the `Save` button.  
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_33.png)  
...
![Script Exit](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_34.png)  
![Select Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_35.png)  

The following function will pop up on the screen:  
![Function Popup](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_36.png)  

Click the `Save` button without typing anything in the `Error Message` field.  
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_37.png)  

### Row 6 Function: PowerShell Script

Add a new row by clicking on the `Add Row` button outside the `If/Then` logic.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_38.png)  
...
![PowerShell Script](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_39.png)  

### Row 7 Logic: If/Then/Else

![Logic](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_40.png)  
![Logic](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_41.png)  

### Row 7a Condition: Output Contains

Type `Failed to Install` in the `Input Value or Variable` field and press `Enter`.  
![Output Contains](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_42.png)  

### Row 7b Function: Set Custom Field

Add a new row by clicking the `Add Row` button inside the `If` section.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_43.png)  

Search and select the `Set Custom Field` function.  
![Set Custom Field](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_44.png)  
![Select Function](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_45.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_46.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_47.png)  
...
Output: %Output%
```
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_48.png)  

### Row 7d Logic: If/Then/Else

Add a new `If/Then/Else` logic inside the `Else` section.  
![Logic](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_49.png)  
![Logic](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_50.png)  

### Row 7d(i) Condition: Output Contains

Change the comparator to `Does Not Contain`.  
![Change Comparator](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_51.png)  

Type `Successfully installed the latest available Cumulative Update` in the `Input Value or Variable` field and press `Enter`.  
![Input Value](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_52.png)  

### Row 7d(ii) Function: Script Log

Click the `Add Row` button after the condition.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_53.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_54.png)  

### Row 7d(iii) Function: Script Exit

Click the `Add Row` button inside the `If/Then` logic.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_55.png)  
...
Add a new row by clicking the `Add Row` button inside the `If` section.  
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_56.png)  
...
![Add Row](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_57.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_58.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_59.png)  
...
```
![PowerShell Script](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_60.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_61.png)  
![Save Confirmation](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_62.png)  
...
```
![PowerShell Script](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_63.png)  
...
![Save Changes](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_64.png)  

## Completed Script

![Completed Script 1](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_65.png)  
![Completed Script 2](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_66.png)  
![Completed Script 3](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_67.png)  
![Completed Script 4](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_68.png)  
...
![Schedule Task](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_69.png)  
5. This screen will appear.  
![Schedule Screen](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_70.png)  
6. Click the `Does not repeat` button.  
![Does Not Repeat](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_71.png)  
7. This pop-up box will appear.  
![Pop-up Box](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_72.png)  
...
![Change Repeat Interval](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_73.png)  
9. Recurrence will be updated to `Every Week on \<Selected Weekday>`.  
![Recurrence Updated](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_74.png)  
10. Select the `Device Groups` option in the `Targeted Resources` section.  
![Targeted Resources](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_75.png)  
11. Search and Select the [Out of Date CU _ Autofix Required](/docs/7ef49988-2b75-441e-9373-bda734a03ea1) device group.  
![Select Device Group](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_76.png)  
12. Now click the `Run` button to initiate the task.  
![Run Task](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_77.png)  
13. The task will start appearing in the Scheduled Tasks.  
![Scheduled Tasks](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_78.png)  
![Scheduled Tasks](../../../static/img/docs/1d9dbd69-f735-4129-8c9d-e72430313371/image_79.png)  
