...
![Sample Run Image 1](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_2.png)

In order to run without DryRun, do not select DryRun.  
![Sample Run Image 2](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_3.png)
...
![Task Creation Image 1](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_4.png)

![Task Creation Image 2](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_5.png)
...
**Category:** Custom  
![Task Creation Image 3](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_6.png)

## Parameters

Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.

![Parameters Image 1](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_7.png)

This screen will appear.  
![Parameters Image 2](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_8.png)
...
![Parameters Image 3](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_9.png)

- It will ask for confirmation to proceed. Click the `Confirm` button to create the parameter.  
![Parameters Image 4](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_10.png)

Parameters will look as shown below:  
![Parameters Image 5](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_11.png)

## Task

Navigate to the Script Editor section and start by adding a row. You can do this by clicking the `Add Row` button at the bottom of the script page.  
![Task Image 1](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_12.png)

A blank function will appear.  
![Task Image 2](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_13.png)

### Row 1 Function: PowerShell Script

Search and select the `PowerShell Script` function.  
![Task Image 3](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_14.png)

The following function will pop up on the screen:  
![Task Image 4](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_15.png)
...
![Task Image 5](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_16.png)

## Completed Task

![Completed Task Image](../../../static/img/docs/a6e7a255-6d3e-4c00-bea0-636533914cbc/image_17.png)
