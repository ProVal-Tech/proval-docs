...
![Sample Run 1](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/{475F174D-1E13-4097-9B84-E8307E02E101}.png>)

To get the list of installed Bloatware:  
![Sample Run 2](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/{CAC8B66A-2258-4389-8823-D9F960D7B465}.png>)
...
![Sample Run 3](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/{794DF09A-FB9B-44D5-ACD1-D2A46BF6A020}.png>)
...
![Sample Run 5](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/{7FBBE24B-991F-41E1-B54B-D94D63513FE2}.png>)
...
![Sample Run 6](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image.png>)

![Sample Run 7](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-1.png>)
...
![Create Task](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_3.png)

- **Name:** Remove - PUA  
- **Description:** This is a CW RMM implementation of the agnostic script [Remove-PUA](/docs/fda5f79b-3e83-4561-af2b-2533f41c7443). This script removes bloatware from a Windows computer. Use the “ListBloatware” parameter to generate a log of installed bloatware from the supported applications. For a list of supported applications, refer to the “Supported Bloatware” section at the very bottom of this document.   
- **Category:** Application  

![Task Detail](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-2.png>)

## Parameters

#### ListBloatware:  
Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add  Parameter 1](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-3.png>)

This screen will appear.  
![Add Parameter 2](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-4.png>)

- Set `ListBloatware` in the `Parameter Name` field.  
- Select `Flag` from the `Parameter Type` dropdown menu.  
- Click the `Save` button.  
![Add Parameter 3](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-5.png>)

#### Remove: 
Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add  Parameter 4](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-3.png>)

This screen will appear.  
![Add Parameter 5](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-4.png>)

- Set `Remove` in the `Parameter Name` field.  
- Select `Text String` from the `Parameter Type` dropdown menu.  
- Click the `Save` button.  
![Add Parameter 6](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-7.png>)

#### RemoveAll:  
Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add  Parameter 7](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-3.png>)

This screen will appear.  
![Add Parameter 8](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-4.png>)

- Set `RemoveAll` in the `Parameter Name` field.  
- Select `Flag` from the `Parameter Type` dropdown menu.  
- Click the `Save` button.  
![Add Parameter 9](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-8.png>)

#### Category:  
Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add  Parameter 10](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-3.png>)

This screen will appear.  
![Add Parameter 11](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-4.png>)

- Set `Category` in the `Parameter Name` field.  
- Select `Text String` from the `Parameter Type` dropdown menu.  
- Click the `Save` button.  
![Add Parameter 12](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-9.png>)

#### Except:  
Add a new parameter by clicking the `Add Parameter` button present at the top-right corner of the screen.  
![Add  Parameter 13](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-3.png>)

This screen will appear.  
![Add Parameter 14](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-4.png>)

- Set `Except` in the `Parameter Name` field.  
- Select `Text String` from the `Parameter Type` dropdown menu.  
- Click the `Save` button.  
![Add Parameter 15](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-10.png>)

### Script

Start by creating three separate rows. You can do this by clicking the "Add Row" button at the bottom of the script page.

![Add Row](../../../static/img/docs/9df5a58f-f44f-4af8-8620-c5670c9d8524/image_5.png)

A blank function will appear.  
![Add Row continued](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-12.png>)

### Row 1: Function: PowerShell Script

![Row 1 Image 1](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-11.png>)

The following function will pop up on the screen:  
![Row 1 Image 2](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-13.png>)
...
![Row 1 Image 3](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-14.png>)

### Row 2: Function: Script Log

Add a new row by clicking the `Add Row` button.  
![Row 2 Image 1](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-15.png>)

A blank function will appear.  
![Row 2 Image 2](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-16.png>)

Search and select the `Script Log` function.  
![Row 2 Image 3](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-17.png>)

![Row 2 Image 4](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-18.png>)

The following function will pop up on the screen:  
![Row 2 Image 5](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-19.png>)

In the script log message, simply type %output% and click the `Save` button  
![Row 2 Image 6](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-20.png>)


Click the `Save` button at the top-right corner of the screen to save the script.  
![Row 2 Image 8](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-21.png>)

## Completed Script

![Row 3 Image 1](<../../../static/img/docs/5f664f90-26b9-4082-9a99-73954de0c840/image-22.png>)
